...
@section('content')
    <section class="season-page-hero" style="background:linear-gradient(145deg,#4A2810,#703818,#602818);color:#FFE8D0;">
        <div>
            ...
            <p class="sp-desc" style="color:#FFE8D088;">Dark Autumn sits at the dramatic intersection of autumn and winter —
                the darkest autumn, with deep, rich, intensely warm colouring. Your natural depth commands attention.</p>
        ...
        <div class="sp-hero-visual">
            ...
            <div class="sp-visual-badges">
                ...
                <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
                    ...
                    <div>
                        <div class="sp-badge-title" style="color:#FFE8D0;">Warm Undertone</div>
                        <div class="sp-badge-sub" style="color:#FFE8D0;">Deep golden-warm</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your skin has a
                        deep, golden warmth — never cool or ashy.</div>
                </div>
                <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
                    <div class="sp-badge-icon">🌑</div>
                    <div>
                        <div class="sp-badge-title" style="color:#FFE8D0;">Dark Value</div>
                        <div class="sp-badge-sub" style="color:#FFE8D0;">Deep, rich depth</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your overall
                        colouring is the darkest of all autumns — deep and intense.</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="season-section">
        ...
        <p class="body-text" style="max-width:560px;margin-bottom:36px;">The darkest, most dramatic warm palette. Deep
            burgundy, dark olive, rich brown, mahogany, and forest green define your season. Your colours are like autumn at
            dusk.</p>
        <div class="two-col">
            <div>
                <div
            ...
            <div>
                ...
                <p class="body-text" style="font-size:14px;">Deep cognac, dark warm brown, and rich espresso are your
                    neutral anchors — intensely warm and deeply grounded.</p>
            </div>
        </div>
    </section>
    ...
    <section class="season-section-alt">
        ...
        <div class="three-col">
            <div class="tooltip-trigger card" style="position:relative;">
                ...
                <div class="body-text" style="font-size:14px;">Medium to deep skin with a strong warm, golden or olive
                    undertone. Often has a richly bronzed quality. Natural depth and warmth are both strong. The darkest
                    autumn colouring.</div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Warm, deep, and rich —
                    never cool or ashy.</div>
            </div>
            <div class="tooltip-trigger card" style="position:relative;">
                <div style="font-size:32px;margin-bottom:14px;">👁️</div>
                <div style="font-size:16px;font-weight:600;color:#2C2420;margin-bottom:8px;">Eyes</div>
                <div class="body-text" style="font-size:14px;">Deep warm brown, dark hazel, dark olive, or amber-brown.
                    Eyes are deeply coloured and warmly rich. A penetrating, intensely warm quality.</div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Intensely warm and
                    deep — often with a golden fleck.</div>
            </div>
            <div class="tooltip-trigger card" style="position:relative;">
                <div style="font-size:32px;margin-bottom:14px;">💇</div>
                <div style="font-size:16px;font-weight:600;color:#2C2420;margin-bottom:8px;">Hair</div>
                <div class="body-text" style="font-size:14px;">Dark auburn, very dark warm brown, dark chestnut, or warm
                    black. Hair is deep and richly warm. May have auburn or chestnut highlights. The deepest autumn hair.
                </div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Deep, warm, and often
                    with a reddish or golden sheen.</div>
            </div>
        </div>
        <div style="margin-top:32px;padding:24px;background:#C0603014;border:1px solid #C0603033;border-radius:16px;">
            <div style="font-size:15px;font-weight:600;color:#2C2420;margin-bottom:6px;">✦ The Dark Autumn glow effect
            </div>
            <div class="body-text" style="font-size:14px;">Dark Autumns in their colours look regal and powerfully
                beautiful — like autumn royalty. The deep, warm colours match their intense natural depth for a commanding,
                striking appearance.</div>
        </div>
    </section>
    ...
    <div id="women-content" class="gender-content active-gender">
        ...
        <section class="season-section">
            ...
            <p class="body-text" style="max-width:560px;margin-bottom:36px;">Rich, deep, and intensely warm. Dark Autumn
                can wear the deepest warm makeup — dark burgundy lips, deep bronze eyes, and rich terracotta cheeks.</p>
            ...
            <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="body-text" style="font-size:14px;">The deepest, warmest foundations in the autumn range.
                        Look for "deep warm golden" or "warm espresso" shades. Nothing cool or ashy.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Choose warm,
                        golden, or olive undertones — avoid pink or neutral.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:14px;font-weight:600;color:#2C2420;margin-bottom:8px;">Key Makeup Rule</div>
                    <div class="body-text" style="font-size:14px;">Deep, warm, and intensely rich. Dark burgundy lips,
                        deep bronze eyes, and rich terracotta blush is the signature Dark Autumn look. You can wear the
                        richest autumn shades.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Embrace the
                        deepest, warmest versions of autumn colours.</div>
                </div>
            </div>
        </section>
                ...
                <div>
                    ...
                    <div class="feature-row">
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            ...
                            <div>
                                <div class="fi-title">Embrace your deep warm neutrals</div>
                                <div class="fi-desc">Dark brown, espresso, cognac, and deep camel are your neutral
                                    foundation. Build every outfit around these rich, deep warm tones.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Your
                                neutrals are as rich as your accent colours — never light or cool.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">02</div>
                            <div>
                                <div class="fi-title">Dark olive is your signature green</div>
                                <div class="fi-desc">Deep, forest-y olive in your warmest, darkest shades is distinctly
                                    yours. It harmonises with your deep, warm features.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Olive green
                                is your power colour — deep, warm, and grounding.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">03</div>
                            <div>
                                <div class="fi-title">Deep burgundy and wine</div>
                                <div class="fi-desc">Unlike other autumns, you can wear deep burgundy and warm wine shades
                                    — they match your natural depth and warmth.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Burgundy is
                                one of your most flattering dramatic colours.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">04</div>
                            <div>
                                <div class="fi-title">Keep it warm and deep always</div>
                                <div class="fi-desc">If a colour looks too bright or too cool, it's wrong for you. Your
                                    palette is always dark, warm, and slightly muted.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Depth +
                                warmth = your formula. No exceptions.</div>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="avoid-grid">
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="avoid-info">
                                ...
                                <div class="avoid-why">Too cool and light</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Cool pink
                                clashes with your warm depth — opt for warm peach or terracotta.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#87CEEB;"></div>
                            <div class="avoid-info">
                                <div class="avoid-name">Light Blue</div>
                                <div class="avoid-why">Too light and cool</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Warm teal or
                                deep olive are your blues, not icy or pastel.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#C0C0C0;"></div>
                            <div class="avoid-info">
                                <div class="avoid-name">Silver</div>
                                <div class="avoid-why">Too cool for your depth</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Silver is
                                too cool — choose antique gold or bronze instead.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#FFFFFF;"></div>
                            <div class="avoid-info">
                                <div class="avoid-name">White</div>
                                <div class="avoid-why">Too harsh a contrast</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Cream,
                                ivory, or warm beige are your light neutrals.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#FFD700;"></div>
                            <div class="avoid-info">
                                <div class="avoid-name">Bright Yellow</div>
                                <div class="avoid-why">Too light and bright</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Mustard or
                                golden yellow is better — not bright lemon.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#000080;"></div>
                            <div class="avoid-info">
                                <div class="avoid-name">Navy</div>
                                <div class="avoid-why">Too cool for warm depth</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Dark
                                charcoal or espresso are better alternatives to cool navy.</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="outfit-grid">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Deep burgundy knit · Dark olive corduroy trousers · Brown leather boots ·
                            Antique copper jewellery</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Effortless depth —
                        rich, warm, and grounded.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Deep wine silk dress · Dark cognac heeled boots · Bronze clutch · Warm
                            amber jewellery</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Dramatic and
                        luxurious — perfect for a night out.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Rich brown structured blazer · Dark olive trousers · Cognac loafers ·
                            Gold chain</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Polished, warm,
                        and unmistakably Dark Autumn.</div>
                </div>
            </div>
        </section>
    </div>
    ...
    <div id="men-content" class="gender-content">
        ...
        <section class="season-section">
            ...
            <p class="body-text" style="max-width:560px;margin-bottom:36px;">Rich, warm, and deep. Your grooming should
                enhance your natural warmth and depth. Avoid anything ashy or cool-toned.</p>
            <div class="makeup-row">
                <div class="tooltip-trigger makeup-item">
            ...
            <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="body-text" style="font-size:14px;">Enhance natural warmth. Use vitamin C and gentle
                        exfoliation to keep skin glowing. Avoid cool-toned or ashy sunscreens — opt for warm, golden-tinted
                        formulas.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Warm, golden
                        skincare keeps your complexion rich and luminous.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:14px;font-weight:600;color:#2C2420;margin-bottom:8px;">Facial Hair</div>
                    <div class="body-text" style="font-size:14px;">Keep facial hair warm and rich. Use a warm brown or
                        amber beard oil. Avoid reddish or cool grey tones. A well-groomed warm beard complements your depth.
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Warm,
                        well-maintained beard enhances your natural depth.</div>
                </div>
            </div>
        </section>
                ...
                <div>
                    ...
                    <div class="feature-row">
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">01</div>
                            <div>
                                <div class="fi-title">Deep warm neutrals</div>
                                <div class="fi-desc">Espresso brown, cognac, dark olive, and warm charcoal are your best
                                    suit and trouser colours. Build your wardrobe from these.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">These
                                neutrals are the foundation of your sophisticated look.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">02</div>
                            <div>
                                <div class="fi-title">Rich accent colours</div>
                                <div class="fi-desc">Deep burgundy, warm wine, or dark forest green in ties, pocket
                                    squares, or sweaters add drama without losing warmth.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Add depth
                                with accents that are as rich as your neutrals.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">03</div>
                            <div>
                                <div class="fi-title">Leather and metal</div>
                                <div class="fi-desc">Warm brown leather (shoes, belts, bags) and antique gold or bronze
                                    hardware. Avoid silver or black leather.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Warm
                                metallics and leather tie your look together.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">04</div>
                            <div>
                                <div class="fi-title">Avoid cool and light colours</div>
                                <div class="fi-desc">No icy blues, stark white, cool greys, or pastels. They will wash you
                                    out and clash with your warmth.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Cool
                                colours drain your warmth — stick to your rich palette.</div>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="avoid-grid">
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Cool pink
                                doesn't suit your warm depth — choose warm peach or rust.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#87CEEB;"></div>
                            <div class="avoid-info">
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Silver is
                                too cool — antique gold or bronze is better.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#FFFFFF;"></div>
                            <div class="avoid-info">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Cream or
                                warm ivory is a better light neutral.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#FFD700;"></div>
                            <div class="avoid-info">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Mustard or
                                golden yellow suits you — not bright lemon.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#000080;"></div>
                            <div class="avoid-info">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Dark
                                charcoal or espresso is a better dark neutral.</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="outfit-grid">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-name">Espresso Suit</div>
                        <div class="outfit-items">Dark brown suit · Deep burgundy tie · Cognac leather shoes · Bronze
                            cufflinks</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Powerful, warm,
                ...
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-name">Dark Olive & Wine</div>
                        <div class="outfit-items">Dark olive chinos · Deep wine sweater · Brown leather boots · Gold watch
                        </div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Rich, relaxed, and
                        distinctly Dark Autumn.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    <div class="outfit-top" style="background:linear-gradient(145deg,#603020,#502010);">🍁</div>
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Cognac corduroy jacket · Warm cream henley · Brown jeans · Leather
                            sneakers</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Casual but
                        polished — embracing your deep warm palette.</div>
                </div>
            </div>
        </section>
    </div>
    ...
    <div id="neutral-content" class="gender-content">
        <section class="season-section">
            ...
            <p class="body-text" style="max-width:560px;margin-bottom:36px;">Dark Autumn is about depth, warmth, and rich
                intensity. These principles work for any gender expression.</p>
            <div
                ...
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="fi-desc" style="font-size:14px;">Espresso, cognac, dark olive, and warm charcoal are your
                        foundation. They ground every outfit.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Deep neutrals are
                        your canvas — build from these.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">🔥</div>
                    <div class="fi-title">Rich warm accents</div>
                    <div class="fi-desc" style="font-size:14px;">Deep burgundy, warm wine, forest green, and burnt orange
                        add drama without losing warmth.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">These accents add
                        depth and interest to your deep neutrals.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">⚜️</div>
                    <div class="fi-title">Metallic finishes</div>
                    <div class="fi-desc" style="font-size:14px;">Antique gold, bronze, and copper jewellery or
                        accessories. Avoid silver or white gold.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Warm metals
                        harmonize with your warm skin tone.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">🍂</div>
                    <div class="fi-title">Texture matters</div>
                    <div class="fi-desc" style="font-size:14px;">Corduroy, velvet, wool, and leather in deep warm colours
                        enhance your rich palette.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Texture adds
                        richness and visual depth to your outfits.</div>
                </div>
            </div>
            <div class="outfit-grid" style="margin-bottom:20px;">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-name">Deep Warmth</div>
                        <div class="outfit-items">Dark olive oversized sweater · Brown wide-leg trousers · Cream sneakers
                            or boots · Bronze pendant</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A versatile,
                        gender-neutral outfit that embodies Dark Autumn depth.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    <div class="outfit-top" style="background:linear-gradient(145deg,#4A2810,#703818);">🔥</div>
                    <div class="outfit-body">
                        <div class="outfit-occasion">Statement Layer</div>
                        <div class="outfit-name">Burgundy Drama</div>
                        <div class="outfit-items">Deep burgundy jacket or cardigan over neutral base · Cognac accessories ·
                            Gold accents</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A bold layer that
                        adds instant warmth and personality.</div>
                </div>
            </div>
        </section>
    </div>
    ...
    <div
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
            <a class="btn btn-outline" style="color:#C06030;border-color:#C0603044;font-size:13px;"
                href="{{ route('show.seasons.custom_pages', ['slug' => 'true-autumn']) }}">True Autumn →</a>
            <a class="btn btn-outline" style="color:#C06030;border-color:#C0603044;font-size:13px;"
