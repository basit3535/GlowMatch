...
@section('content')
    <section class="season-page-hero" style="background:linear-gradient(145deg,#8A4A20,#B06030,#904820);color:#FFF0D8;">
        <div>
            ...
            <p class="sp-desc" style="color:#FFF0D888;">True Autumn is the quintessential autumn — the most warm, earthy,
                and richly muted of all seasons. Your colouring is nature's palette in full harvest glory: terracotta,
                olive, and burnished gold.</p>
        ...
        <div class="sp-hero-visual">
            ...
            <div class="sp-visual-badges">
                ...
                <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
                    ...
                    <div>
                        <div class="sp-badge-title" style="color:#FFF0D8;">Warm Undertone</div>
                        <div class="sp-badge-sub" style="color:#FFF0D8;">Golden, earthy</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your skin has a
                        strong golden or olive warmth — the hallmark of True Autumn.</div>
                </div>
                <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
                    <div class="sp-badge-icon">🎨</div>
                    <div>
                        <div class="sp-badge-title" style="color:#FFF0D8;">Muted Quality</div>
                        <div class="sp-badge-sub" style="color:#FFF0D8;">Rich, earthy</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your colours are
                        warm but muted — not bright or clear, but rich and earthy.</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="season-section">
        ...
        <p class="body-text" style="max-width:560px;margin-bottom:36px;">Your palette is the earth itself — terracotta,
            burnt orange, olive green, warm gold, and rich brown. Every shade has warmth and a slightly muted quality.</p>
        <div class="two-col">
            <div>
                <div
            ...
            <div>
                ...
                <p class="body-text" style="font-size:14px;">Rich camel, warm tan, and deep cognac form your neutral
                    foundation — always earthy and warm.</p>
            </div>
        </div>
    </section>
    ...
    <section class="season-section-alt">
        ...
        <div class="three-col">
            <div class="tooltip-trigger card" style="position:relative;">
                ...
                <div class="body-text" style="font-size:14px;">Light to deep skin with a strong golden or olive warm
                    undertone. Often tans deeply. May have a naturally bronzed quality year-round. Golden warm depth is the
                    hallmark.</div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Strong warm undertone
                    — golden or olive, never cool or pink.</div>
            </div>
            <div class="tooltip-trigger card" style="position:relative;">
                <div style="font-size:32px;margin-bottom:14px;">👁️</div>
                <div style="font-size:16px;font-weight:600;color:#2C2420;margin-bottom:8px;">Eyes</div>
                <div class="body-text" style="font-size:14px;">Hazel, warm brown, amber, or warm olive green — often with
                    rich golden flecks. Eyes are warm and deeply coloured. A richly warm quality to the gaze.</div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Warm, deep eyes with
                    golden flecks — rich and earthy.</div>
            </div>
            <div class="tooltip-trigger card" style="position:relative;">
                <div style="font-size:32px;margin-bottom:14px;">💇</div>
                <div style="font-size:16px;font-weight:600;color:#2C2420;margin-bottom:8px;">Hair</div>
                <div class="body-text" style="font-size:14px;">Auburn, chestnut, warm dark brown, or warm black. Hair has
                    a richly warm quality — often with natural red or golden highlights. The most distinctly warm hair of
                    all seasons.</div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Rich, warm hair —
                    often auburn or chestnut with golden highlights.</div>
            </div>
        </div>
        <div style="margin-top:32px;padding:24px;background:#C4783814;border:1px solid #C4783833;border-radius:16px;">
            <div style="font-size:15px;font-weight:600;color:#2C2420;margin-bottom:6px;">✦ The True Autumn glow effect
            </div>
            <div class="body-text" style="font-size:14px;">True Autumns in their colours look powerfully, richly beautiful
                — like a person surrounded by autumn leaves. The warm earth tones amplify their natural warmth to create a
                deeply alive, radiant appearance.</div>
        </div>
    </section>
    ...
    <div id="women-content" class="gender-content active-gender">
        ...
        <section class="season-section">
            ...
            <p class="body-text" style="max-width:560px;margin-bottom:36px;">Rich, warm, and earthy. True Autumn can wear
                the most intense warm makeup of any season without being overwhelmed.</p>
            ...
            <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="body-text" style="font-size:14px;">Strong warm, golden foundations. True Autumn often
                        needs the warmest, most golden-toned foundation available. Never pink or cool.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Warm golden or
                        olive undertones — nothing pink or neutral.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:14px;font-weight:600;color:#2C2420;margin-bottom:8px;">Key Makeup Rule</div>
                    <div class="body-text" style="font-size:14px;">Think earth, spice, and harvest. Terracotta lip, bronzy
                        eyes, and a brick blush is the ultimate True Autumn look. Rich and earthy, never cool.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Rich, warm, earthy
                        colours are your signature — never cool or bright.</div>
                </div>
            </div>
        </section>
                ...
                <div>
                    ...
                    <div class="feature-row">
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            ...
                            <div>
                                <div class="fi-title">Terracotta is your signature</div>
                                <div class="fi-desc">No season wears terracotta like True Autumn. It's not just a colour
                                    for you — it's almost your second skin.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Terracotta
                                is your power colour — it brings out your warmth like no other.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">02</div>
                            <div>
                                <div class="fi-title">Olive green is essential</div>
                                <div class="fi-desc">Warm olive in every shade — from soft sage to deep forest olive — is
                                    one of your most powerful and versatile colours.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Olive
                                harmonises with your earthy warmth — a must-have colour.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">03</div>
                            <div>
                                <div class="fi-title">Build around warm browns</div>
                                <div class="fi-desc">Rich brown, cognac, tan, and camel form the backbone of your wardrobe.
                                    These neutrals anchor every outfit.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Warm browns
                                are your neutral anchors — they ground your look.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">04</div>
                            <div>
                                <div class="fi-title">Gold accessories only</div>
                                <div class="fi-desc">Warm gold, antique gold, and burnished copper in jewellery enhance
                                    your warm depth. Silver fights your undertone.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Gold,
                                brass, and copper — never silver.</div>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="avoid-grid">
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="avoid-info">
                                ...
                                <div class="avoid-why">Clashes with warm depth</div>
                            </div>
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="avoid-info">
                                <div class="avoid-name">Cool Blue</div>
                                <div class="avoid-why">Too cool and contrasting</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Cool blue
                                fights your warmth — choose teal or warm blue.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Navy is too
                                cool — choose dark olive or charcoal.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#F0F0F0;"></div>
                            <div class="avoid-info">
                                <div class="avoid-name">Cool White</div>
                                <div class="avoid-why">Washes out your warmth</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Cool white
                                is too stark — choose warm cream or ivory.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
            ...
            <div class="outfit-grid">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Terracotta linen top · Dark olive wide-leg trousers · Cognac leather
                            boots · Bronze earrings</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Warm, earthy, and
                        effortlessly True Autumn.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Warm mustard knit sweater · Rich brown corduroy · Tan leather boots ·
                            Antique gold pendant</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Rich, golden, and
                        beautifully autumnal.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Deep olive silk wrap dress · Brown heeled boots · Tortoiseshell clutch ·
                            Gold chain necklace</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Elegant, earthy,
                        and deeply warm.</div>
                </div>
            </div>
        </section>
    ...
    <div id="men-content" class="gender-content">
        ...
        <section class="season-section">
            ...
            <p class="body-text" style="max-width:560px;margin-bottom:36px;">Rich, warm, and natural. Your grooming should
                enhance your earthy warmth and golden undertones.</p>
            <div class="makeup-row">
                <div class="tooltip-trigger makeup-item">
                    <div class="makeup-swatch" style="background:#C47A5A;"></div>
            ...
            <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="body-text" style="font-size:14px;">Natural radiance and warmth. Use products that enhance
                        your golden undertone. Avoid anything that leaves an ashy or cool finish.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Warm, radiant
                        skincare enhances your natural glow.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:14px;font-weight:600;color:#2C2420;margin-bottom:8px;">Facial Hair</div>
                    <div class="body-text" style="font-size:14px;">Keep facial hair warm and rich. Use warm brown or
                        honey-toned beard oils. Avoid cool, ashy, or reddish tones that don't match your warmth.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Warm, rich facial
                        hair complements your earthy colouring.</div>
                </div>
            </div>
        </section>
                ...
                <div>
                    ...
                    <div class="feature-row">
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">01</div>
                            <div>
                                <div class="fi-title">Embrace warm earthy neutrals</div>
                                <div class="fi-desc">Camel, rich brown, cognac, and tan are your core suit and trouser
                                    colours. Avoid charcoal and navy.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Warm earthy
                                neutrals are your foundation — they suit your natural warmth.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">02</div>
                            <div>
                                <div class="fi-title">Olive and terracotta accents</div>
                                <div class="fi-desc">Olive green shirts, terracotta ties, or warm mustard pocket squares
                                    add signature True Autumn energy.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">These
                                accents bring your earthy warmth to life.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">03</div>
                            <div>
                                <div class="fi-title">Gold and warm leather</div>
                                <div class="fi-desc">Gold watches, warm brown leather shoes and belts, and tortoiseshell
                                    accessories complement your earthy warmth.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Gold and
                                warm leathers tie your look together naturally.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">04</div>
                            <div>
                                <div class="fi-title">Avoid cool and bright colours</div>
                                <div class="fi-desc">No black, navy, cool greys, bright whites, or pastels. They will drain
                                    your warm colouring.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Cool and
                                bright colours wash out your warmth — avoid them.</div>
                        </div>
                    </div>
                </div>
                <div>
            ...
            <div class="outfit-grid">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Warm camel suit · Olive green tie · Cream shirt · Brown leather oxfords ·
                            Gold watch</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Sophisticated,
                        warm, and professionally True Autumn.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    <div class="outfit-top" style="background:linear-gradient(145deg,#D4A856,#B08030);">🌾</div>
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Mustard sweater · Brown chinos · Tan leather boots · Tortoiseshell
                            sunglasses</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Warm, stylish, and
                ...
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-name">Olive & Tan</div>
                        <div class="outfit-items">Olive field jacket · Cream henley · Brown jeans · Tan work boots ·
                            Leather strap watch</div>
                    </div>
    ...
    <div id="neutral-content" class="gender-content">
        <section class="season-section">
            ...
            <p class="body-text" style="max-width:560px;margin-bottom:36px;">True Autumn is about rich warmth, earthy
                depth, and natural harmony. These principles work for any gender expression.</p>
            <div
                ...
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="fi-desc" style="font-size:14px;">Camel, cognac, tan, and rich brown are your foundation.
                        Avoid cool greys, navy, and black.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Your neutrals are
                        warm and earthy — never cool or stark.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">🌾</div>
                    <div class="fi-title">Harvest colours</div>
                    <div class="fi-desc" style="font-size:14px;">Terracotta, mustard, burnt orange, and warm olive are
                        your signature accent colours.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">These harvest
                        colours are your signature — rich and earthy.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">⚜️</div>
                    <div class="fi-title">Warm metals</div>
                    <div class="fi-desc" style="font-size:14px;">Gold, brass, copper, and bronze. Avoid silver, platinum,
                        or chrome.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Warm metals
                        enhance your earthy warmth — silver is too cool.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">🌰</div>
                    <div class="fi-title">Natural textures</div>
                    <div class="fi-desc" style="font-size:14px;">Leather, suede, corduroy, wool, and linen in warm earthy
                        tones enhance your natural richness.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Natural textures
                        in warm tones amplify your earthy aesthetic.</div>
                </div>
            </div>
            <div class="outfit-grid" style="margin-bottom:20px;">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Camel coat or jacket · Olive trousers · Brown leather boots · Gold
                            jewellery or watch</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A versatile, warm
                        unisex look that's naturally stylish.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    <div class="outfit-top" style="background:linear-gradient(145deg,#D4A856,#B08030);">🌾</div>
                    <div class="outfit-body">
                        <div class="outfit-occasion">Accent Layer</div>
                        <div class="outfit-name">Mustard Pop</div>
                        <div class="outfit-items">Mustard sweater or hoodie · Brown or cream base · Tan accessories · Gold
                            details</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A warm, bold
                        accent layer that brings your outfit to life.</div>
                </div>
            </div>
        </section>
    </div>
