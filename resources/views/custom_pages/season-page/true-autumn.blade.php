        ...
        <div>
            <div class="sp-eyebrow">
                ...
                <span class="sp-season-type"
                    style="color:#C47838;">{{ $data->content->season_hero_eyebrow_label->value ?? '' }}</span>
            </div>
        ...
        <div class="sp-hero-visual">
            ...
            <div class="sp-visual-badges">
                ...
                <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
                    ...
                    <div>
                        <div class="sp-badge-title" style="color:#FFF0D8;">
                            {{ $data->content->season_badge1_title->value ?? '' }}</div>
                        <div class="sp-badge-sub" style="color:#FFF0D8;">
    ...
    <div id="women-content" class="gender-content active-gender">
        ...
        <section class="season-section-alt">
            <div class="two-col">
                <div>
                    <span class="lbl"
                        style="color:#C47838;">{{ $data->content->wardrobe_women_label->value ?? '' }}</span>
                ...
                <div>
                    ...
                    <div class="avoid-grid">
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">
                                {{ $data->content->avoid_cool_blue_tooltip->value ?? '' }}</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">
                                {{ $data->content->avoid_cool_white_tooltip->value ?? '' }}</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
    ...
    <div id="men-content" class="gender-content">
        ...
        <section class="season-section-alt">
            <div class="two-col">
                <div>
                    <span class="lbl"
                        style="color:#C47838;">{{ $data->content->wardrobe_men_label->value ?? '' }}</span>
        ...
        <h2 class="h2" style="margin-bottom:36px;">{{ $data->content->celebrities_title->value ?? '' }}</div>
            <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:24px;">
                ...
                <div class="tooltip-trigger celeb-card" style="position:relative;">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her rich auburn
                        hair
                ...
                <div class="tooltip-trigger celeb-card" style="position:relative;">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her warm red hair
                        and
                ...
                <div class="tooltip-trigger celeb-card" style="position:relative;">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">His warm olive
                        skin
