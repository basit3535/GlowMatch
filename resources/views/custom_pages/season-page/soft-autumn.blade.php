...
@section('content')
    <section class="season-page-hero" style="background:linear-gradient(145deg,#C09070,#A87050,#906038);color:#FFF4E8;">
        <div>
            ...
            <p class="sp-desc" style="color:#FFF4E888;">Soft Autumn is the gentlest of the autumn seasons — warm but muted,
                and beautifully natural-looking. Your colouring is the most approachable and versatile in the entire
                12-season system.</p>
        ...
        <div class="sp-hero-visual">
            ...
            <div class="sp-visual-badges">
                ...
                <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
                    ...
                    <div>
                        <div class="sp-badge-title" style="color:#FFF4E8;">Neutral-Warm</div>
                        <div class="sp-badge-sub" style="color:#FFF4E8;">Gently warm</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your warmth is
                        subtle — you sit between true autumn and summer.</div>
                </div>
                <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
                    <div class="sp-badge-icon">🎨</div>
                    <div>
                        <div class="sp-badge-title" style="color:#FFF4E8;">Muted Quality</div>
                        <div class="sp-badge-sub" style="color:#FFF4E8;">Soft, natural</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your colours are
                        never harsh or vivid — they blend softly into your features.</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="season-section">
        ...
        <p class="body-text" style="max-width:560px;margin-bottom:36px;">Your palette is warm and muted — nature's own
            colours. Dusty rose, warm taupe, soft olive, muted peach, and natural tones define the Soft Autumn aesthetic.
        </p>
        <div class="two-col">
            <div>
                <div
            ...
            <div>
                ...
                <p class="body-text" style="font-size:14px;">Warm greige, dusty camel, and muted mushroom form your
                    neutral base — always warm but never stark.</p>
            </div>
        </div>
    </section>
    ...
    <section class="season-section-alt">
        ...
        <div class="three-col">
            <div class="tooltip-trigger card" style="position:relative;">
                ...
                <div class="body-text" style="font-size:14px;">Fair to medium skin with a warm, peachy or golden undertone
                    — but less vivid than True Autumn. May have a slightly peachy or warm flush. Often described as having a
                    "natural" quality.</div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Warm but muted — your
                    skin has a soft, natural glow.</div>
            </div>
            <div class="tooltip-trigger card" style="position:relative;">
                <div style="font-size:32px;margin-bottom:14px;">👁️</div>
                <div style="font-size:16px;font-weight:600;color:#2C2420;margin-bottom:8px;">Eyes</div>
                <div class="body-text" style="font-size:14px;">Warm hazel, soft brown, or warm green — often with golden
                    flecks but less vivid than True Autumn. Eyes appear softly warm and natural.</div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Soft, warm, and
                    approachable — not striking but beautiful.</div>
            </div>
            <div class="tooltip-trigger card" style="position:relative;">
                <div style="font-size:32px;margin-bottom:14px;">💇</div>
                <div style="font-size:16px;font-weight:600;color:#2C2420;margin-bottom:8px;">Hair</div>
                <div class="body-text" style="font-size:14px;">Light to medium warm brown, soft auburn, or golden-tinged
                    brown. Hair is warm but not richly so. Natural highlights are common. An approachable, natural warmth.
                </div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Warm, soft hair with
                    natural highlights — never too dark or rich.</div>
            </div>
        </div>
        <div style="margin-top:32px;padding:24px;background:#90603814;border:1px solid #90603833;border-radius:16px;">
            <div style="font-size:15px;font-weight:600;color:#2C2420;margin-bottom:6px;">✦ The Soft Autumn glow effect
            </div>
            <div class="body-text" style="font-size:14px;">Soft Autumns in their colours look naturally beautiful — as
                though they never needed to try. The warm, muted tones blend seamlessly with their features for an
                effortlessly healthy look.</div>
        </div>
    </section>
    ...
    <div id="women-content" class="gender-content active-gender">
        ...
        <section class="season-section">
            ...
            <p class="body-text" style="max-width:560px;margin-bottom:36px;">Warm but soft — every shade should look like
                a natural extension of your colouring. Think "warm no-makeup makeup."</p>
            ...
            <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="body-text" style="font-size:14px;">Warm, peachy-beige foundations — warmer than neutral
                        but less golden than True Autumn. Look for "warm beige" or "soft golden" shades.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Warm but not too
                        golden — just a hint of warmth.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:14px;font-weight:600;color:#2C2420;margin-bottom:8px;">Key Makeup Rule</div>
                    <div class="body-text" style="font-size:14px;">Warm and blended. Nothing too vivid or sharp. A warm
                        peachy nude lip, a terracotta blush, and a soft taupe eyeshadow is the perfect Soft Autumn look.
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Soft, warm, and
                        blended — always natural-looking.</div>
                </div>
            </div>
        </section>
                ...
                <div>
                    ...
                    <div class="feature-row">
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            ...
                            <div>
                                <div class="fi-title">Dusty rose is surprisingly yours</div>
                                <div class="fi-desc">Unlike other autumns, you can wear dusty rose — the warm version. It
                                    bridges your autumn warmth with summer's softness.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Dusty rose
                                is your secret weapon — warm, soft, and flattering.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">02</div>
                            <div>
                                <div class="fi-title">Your olive is soft, not rich</div>
                                <div class="fi-desc">Soft olive and sage green are perfect for you — they harmonise with
                                    your warm but muted natural colouring.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Soft, muted
                                greens are your best — they blend with your earthy warmth.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">03</div>
                            <div>
                                <div class="fi-title">Camel is your ultimate neutral</div>
                                <div class="fi-desc">Warm camel, tan, and mushroom are your wardrobe staples — they blend
                                    with everything in your muted warm palette.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Camel is
                                your neutral anchor — it works with all your colours.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">04</div>
                            <div>
                                <div class="fi-title">Avoid both extremes</div>
                                <div class="fi-desc">You sit between seasons, so avoid the richest autumn colours AND the
                                    coolest summer colours — stay in the muted warm middle.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Stay in the
                                middle — not too rich, not too cool.</div>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="avoid-grid">
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="avoid-info">
                                <div class="avoid-name">Navy Blue</div>
                                <div class="avoid-why">Too cool and too dark</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Navy is too
                                cool and stark — choose warm navy or olive.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#FF69B4;"></div>
                            <div class="avoid-info">
                                <div class="avoid-name">Hot Pink</div>
                                <div class="avoid-why">Too cool and vivid</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Hot pink is
                                too vivid — choose dusty rose or muted peach.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#FFD700;"></div>
                            <div class="avoid-info">
                                <div class="avoid-name">Bright Yellow</div>
                                <div class="avoid-why">Too clear, needs more muting</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Bright
                                yellow is too clear — choose mustard or warm ochre.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#FF0000;"></div>
                            <div class="avoid-info">
                                <div class="avoid-name">Pure Red</div>
                                <div class="avoid-why">Too vivid and clear</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Pure red is
                                too vivid — choose brick red or burnt orange.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#C0C0C0;"></div>
                            <div class="avoid-info">
                                <div class="avoid-name">Cool Silver</div>
            ...
            <div class="outfit-grid">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Warm camel oversized sweater · Olive straight jeans · Tan ankle boots ·
                            Wooden bead necklace</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Effortless,
                        natural, and beautifully warm.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Dusty rose linen shirt · Warm taupe trousers · Camel loafers · Hammered
                            gold earrings</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Soft, feminine,
                        and perfectly Soft Autumn.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Soft olive silk wrap dress · Cognac heels · Simple gold chain · Warm
                            brown clutch</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Elegant, warm, and
                        understatedly beautiful.</div>
                </div>
            </div>
        </section>
    </div>
    ...
    <div id="men-content" class="gender-content">
        ...
        <section class="season-section">
            ...
            <p class="body-text" style="max-width:560px;margin-bottom:36px;">Warm, natural, and effortless. Your grooming
                should enhance your natural warmth without looking artificial.</p>
            <div class="makeup-row">
                <div class="tooltip-trigger makeup-item">
                    <div class="makeup-swatch" style="background:#D4A882;"></div>
            ...
            <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="body-text" style="font-size:14px;">Natural radiance and hydration. Use gentle, warm-toned
                        products that enhance your skin's natural glow. Avoid cool or ashy finishes.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Warm, hydrating
                        skincare keeps your skin naturally luminous.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:14px;font-weight:600;color:#2C2420;margin-bottom:8px;">Facial Hair</div>
                    <div class="body-text" style="font-size:14px;">Keep facial hair warm and soft. Use warm brown or
                        honey-toned beard oils. Avoid cool, ashy, or reddish tones. A well-groomed natural beard suits you
                        well.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Warm, soft beard
                        care complements your natural features.</div>
                </div>
            </div>
        </section>
                    ...
                    <div class="feature-row">
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            ...
                            <div>
                                ...
                                <div class="fi-desc">Camel, warm taupe, olive, and mushroom are your best suit and trouser
                                    colours. Avoid charcoal and navy.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Warm, muted
                                neutrals are your foundation — they suit your natural warmth.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">02</div>
                            <div>
                                <div class="fi-title">Soft earthy accents</div>
                                <div class="fi-desc">Dusty rose, soft olive, and muted peach in shirts, polos, or ties add
                                    the right amount of colour without being overpowering.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Soft
                                accents add life without overwhelming your muted warmth.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">03</div>
                            <div>
                                <div class="fi-title">Gold and warm leather</div>
                                <div class="fi-desc">Gold watches, warm brown leather shoes and belts, and wood accessories
                                    complement your natural warmth.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Gold and
                                warm leather tie your look together naturally.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">04</div>
                            <div>
                                <div class="fi-title">Avoid cool and bright colours</div>
                                <div class="fi-desc">No black, navy, bright white, cool greys, or neon colours. They will
                                    wash you out and clash with your warmth.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Cool and
                                bright colours drain your natural warmth — avoid them.</div>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="avoid-grid">
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Bright
                                yellow is too clear — choose mustard or ochre.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#C0C0C0;"></div>
                            <div class="avoid-info">
            ...
            <div class="outfit-grid">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-name">Warm Camel Suit</div>
                        <div class="outfit-items">Camel suit · Dusty rose tie · Cream shirt · Brown leather oxfords · Gold
                            watch</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Sophisticated,
                        warm, and professionally Soft Autumn.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    <div class="outfit-top" style="background:linear-gradient(145deg,#BC8F8F,#A07070);">🌹</div>
                    <div class="outfit-body">
                        <div class="outfit-occasion">Smart Casual</div>
                        <div class="outfit-name">Dusty Rose Polo</div>
                        <div class="outfit-items">Dusty rose polo · Olive chinos · Tan suede loafers · Brown leather belt
                        </div>
                    </div>
                ...
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-name">Sage & Sand</div>
                        <div class="outfit-items">Sage green sweater · Warm sand trousers · Tan boots · Simple gold chain
                        </div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Relaxed, warm, and
                        naturally handsome.</div>
                </div>
            </div>
        </section>
    </div>
    ...
    <div id="neutral-content" class="gender-content">
        <section class="season-section">
            ...
            <p class="body-text" style="max-width:560px;margin-bottom:36px;">Soft Autumn is about warm muting, natural
                harmony, and effortless elegance. These principles work for any gender expression.</p>
            <div
                style="display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:20px;margin-bottom:32px;">
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">🍂</div>
                    <div class="fi-title">Warm, muted neutrals</div>
                    <div class="fi-desc" style="font-size:14px;">Camel, warm taupe, mushroom, and greige are your
                        foundation. Avoid stark white or cool greys.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">These neutrals are
                        your base — warm and soft, never stark.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">🌹</div>
                    <div class="fi-title">Soft dusty accents</div>
                    <div class="fi-desc" style="font-size:14px;">Dusty rose, soft olive, muted peach, and sage green bring
                        gentle colour without overwhelming.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Soft, muted
                        accents add just the right amount of colour.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">⚜️</div>
                    <div class="fi-title">Warm metals</div>
                    <div class="fi-desc" style="font-size:14px;">Gold, brass, rose gold, and bronze. Avoid silver,
                        platinum, or chrome.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Warm metals
                        enhance your natural warmth — silver is too cool.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">🍃</div>
                    <div class="fi-title">Keep it natural</div>
                    <div class="fi-desc" style="font-size:14px;">Your look should feel organic and easy. Natural fibres
                        (linen, cotton, wool) in muted warm tones suit you perfectly.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Natural textures
                        and fibres complement your effortless style.</div>
                </div>
            </div>
            <div class="outfit-grid" style="margin-bottom:20px;">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Camel linen shirt/jacket · Olive trousers · Tan boots/sandals · Gold
                            accessories</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A versatile, warm,
                        and naturally stylish unisex outfit.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    <div class="outfit-top" style="background:linear-gradient(145deg,#BC8F8F,#A07070);">🌹</div>
                    <div class="outfit-body">
                        <div class="outfit-occasion">Soft Accent</div>
                        <div class="outfit-name">Dusty Rose Layer</div>
                        <div class="outfit-items">Dusty rose cardigan or hoodie over warm neutral base · Brown leather
                            details</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A soft, warm layer
                        that adds personality without overwhelming.</div>
                </div>
            </div>
        </section>
    </div>
    ...
    <div
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
            ...
            <a class="btn btn-outline" style="color:#906038;border-color:#90603844;font-size:13px;"
                href="{{ route('show.seasons.custom_pages', ['slug' => 'soft-summer']) }}">Soft Summer →</a>
        </div>
    </div>
