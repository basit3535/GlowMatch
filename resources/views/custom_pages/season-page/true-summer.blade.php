...
@section('content')
    <section class="season-page-hero" style="background:linear-gradient(145deg,#B8C8E0,#9AAAC8,#7A8AAC);color:#F8F4FF;">
        <div>
            ...
            <p class="sp-desc" style="color:#F8F4FF888;">True Summer is the quintessential summer — cool, muted, and with a
                quietly breathtaking romantic quality. Your colouring has a natural softness that makes dusty rose and
                lavender your destiny.</p>
        ...
        <div class="sp-hero-visual">
            ...
            <div class="sp-visual-badges">
                ...
                <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
                    ...
                    <div>
                        <div class="sp-badge-title" style="color:#F8F4FF;">Cool Undertone</div>
                        <div class="sp-badge-sub" style="color:#F8F4FF;">Rosy, bluish cool</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your skin has a
                        distinct pink or rosy cool undertone — never golden.</div>
                </div>
                <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
                    <div class="sp-badge-icon">🎨</div>
                    <div>
                        <div class="sp-badge-title" style="color:#F8F4FF;">Muted Quality</div>
                        <div class="sp-badge-sub" style="color:#F8F4FF;">Soft, blended</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your colours are
                        soft and muted — never bright or clear.</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="season-section">
        ...
        <p class="body-text" style="max-width:560px;margin-bottom:36px;">Your palette is cool and muted — like colours seen
            through the softest filter. Dusty rose, lavender, powder blue, mauve, and soft sage define your season.</p>
        <div class="two-col">
            <div>
                <div
            ...
            <div>
                ...
                <p class="body-text" style="font-size:14px;">Soft grey-lavender, cool greige, and dusty mauve are your
                    perfect neutrals — always subtly cool.</p>
            </div>
        </div>
    </section>
    ...
    <section class="season-section-alt">
        ...
        <div class="three-col">
            <div class="tooltip-trigger card" style="position:relative;">
                ...
                <div class="body-text" style="font-size:14px;">Fair to medium skin with a pink or rosy cool undertone.
                    Often has a porcelain or rose-touched quality. May have faint rose or pink flush naturally. Burns in
                    sun.</div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Cool, rosy, and
                    delicate — burns easily, never tans golden.</div>
            </div>
            <div class="tooltip-trigger card" style="position:relative;">
                <div style="font-size:32px;margin-bottom:14px;">👁️</div>
                <div style="font-size:16px;font-weight:600;color:#2C2420;margin-bottom:8px;">Eyes</div>
                <div class="body-text" style="font-size:14px;">Grey-blue, grey-green, soft hazel, or pale violet-grey.
                    Eyes often appear soft and slightly greyed — never vivid. A romantic, quiet quality to the gaze.</div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Soft, greyed eyes —
                    romantic and quiet, never bright.</div>
            </div>
            <div class="tooltip-trigger card" style="position:relative;">
                <div style="font-size:32px;margin-bottom:14px;">💇</div>
                <div style="font-size:16px;font-weight:600;color:#2C2420;margin-bottom:8px;">Hair</div>
                <div class="body-text" style="font-size:14px;">Ash blonde, mousy brown, cool dark brown, or ashy chestnut.
                    Always distinctly cool and ashy — never golden or warm. Hair may appear to have blue or cool highlights.
                </div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Cool, ashy hair — no
                    warmth at all.</div>
            </div>
        </div>
        <div style="margin-top:32px;padding:24px;background:#6880A814;border:1px solid #6880A833;border-radius:16px;">
            <div style="font-size:15px;font-weight:600;color:#2C2420;margin-bottom:6px;">✦ The True Summer glow effect
            </div>
            <div class="body-text" style="font-size:14px;">True Summers in their colours emanate a romantic, softly
                beautiful quality — like a Pre-Raphaelite painting come to life. The muted cool colours create harmony with
                their naturally soft features.</div>
        </div>
    </section>
    ...
    <div id="women-content" class="gender-content active-gender">
        ...
        <section class="season-section">
            ...
            <p class="body-text" style="max-width:560px;margin-bottom:36px;">Keep makeup cool, muted, and softly blended.
                Your keyword is "dusty" — everything should have a slightly softened, powdery quality.</p>
            ...
            <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="body-text" style="font-size:14px;">Cool, rosy-pink undertone foundations. Look for shades
                        described as "rose beige" or "cool beige." Avoid anything with yellow or peach undertones.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Rosy-pink
                        undertones — never yellow or peach.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:14px;font-weight:600;color:#2C2420;margin-bottom:8px;">Key Makeup Rule</div>
                    <div class="body-text" style="font-size:14px;">The word is "dusty." Dusty rose, dusty lavender, dusty
                        mauve. Bright or clear colours look too artificial on you — the softened, muted version is always
                        better.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Dusty, muted
                        shades are your signature — nothing bright.</div>
                </div>
            </div>
        </section>
                ...
                <div>
                    ...
                    <div class="feature-row">
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            ...
                            <div>
                                <div class="fi-title">Dusty rose is your superpower</div>
                                <div class="fi-desc">No season wears dusty rose like True Summer. It blends with your
                                    colouring so beautifully it looks as if it were invented for you.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Dusty rose
                                is your signature colour — it's made for you.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">02</div>
                            <div>
                                <div class="fi-title">Build a muted cool wardrobe</div>
                                <div class="fi-desc">Invest in lavender, dusty blue, soft sage, cool mauve, and powder grey
                                    as your wardrobe staples — these all harmonise effortlessly.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Muted cool
                                colours harmonise — build your wardrobe around them.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">03</div>
                            <div>
                                <div class="fi-title">Silver over gold always</div>
                                <div class="fi-desc">Silver, white gold, and platinum jewellery enhances your cool
                                    undertone. Gold can fight with your natural colouring.</div>
                            </div>
                        ...
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            ...
                            <div>
                                ...
                                <div class="fi-desc">Bright, saturated colours look artificial against your soft, muted
                                    natural colouring. The dustier the shade, the better.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Bright
                                colours overwhelm you — stick to soft, dusty tones.</div>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="avoid-grid">
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="avoid-info">
                                ...
                                <div class="avoid-why">Warm and clashing</div>
                            </div>
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="avoid-info">
                                ...
                                <div class="avoid-why">Too warm and sharp</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Yellow is
                                too bright and warm — choose muted butter.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#FF4500;"></div>
                            <div class="avoid-info">
                                <div class="avoid-name">Red-Orange</div>
                                <div class="avoid-why">Too warm and bright</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Red-orange
                                is too vivid — choose muted brick.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#8B4513;"></div>
                            <div class="avoid-info">
                                <div class="avoid-name">Warm Brown</div>
                                <div class="avoid-why">Warm tones clash</div>
                            </div>
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="avoid-info">
                                <div class="avoid-name">Forest Green</div>
                                <div class="avoid-why">Too warm and heavy</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Forest green
                                is too warm — choose soft sage.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#FF1493;"></div>
                            <div class="avoid-info">
                                <div class="avoid-name">Hot Pink</div>
                                <div class="avoid-why">Too bright and warm</div>
                            </div>
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Hot pink is
                                too bright — choose dusty rose or mauve.</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="outfit-grid">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Dusty rose silk blouse · Soft grey tailored trousers · Nude pointed flats
                            · Silver earrings</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Soft, romantic,
                        and perfectly True Summer.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Powder blue linen shirt · Pale grey straight jeans · White trainers ·
                            Silver pendant</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Cool, casual, and
                        effortlessly elegant.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Soft lavender midi dress · Strappy silver heels · Silver clutch ·
                            Amethyst drop earrings</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Romantic, cool,
    ...
    <div id="men-content" class="gender-content">
        ...
        <section class="season-section">
            ...
            <p class="body-text" style="max-width:560px;margin-bottom:36px;">Cool, soft, and understated. Your grooming
                should enhance your natural coolness and muted features without adding warmth or harshness.</p>
            <div class="makeup-row">
                <div class="tooltip-trigger makeup-item">
            ...
            <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="body-text" style="font-size:14px;">Evenness and gentle hydration. Use soothing,
                        neutral-cool products. Avoid self-tanners or anything that adds warmth. A porcelain, calm finish
                        suits you best.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Calm, even skin is
                        your goal — avoid warmth.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:14px;font-weight:600;color:#2C2420;margin-bottom:8px;">Facial Hair</div>
                    <div class="body-text" style="font-size:14px;">Keep facial hair neat and cool-toned. Use ash brown or
                        cool taupe beard oils. Avoid any warm, red, or golden tones. A clean-shaven or very light stubble
                        look works best.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Cool, neat facial
                        hair — no warmth or redness.</div>
                </div>
            </div>
        </section>
                ...
                <div>
                    ...
                    <div class="feature-row">
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">01</div>
                            <div>
                                <div class="fi-title">Cool muted neutrals</div>
                                <div class="fi-desc">Soft grey, cool navy (not bright), dusty blue, and grey-lavender are
                                    your best suit and trouser colours. Avoid warm camel or dark brown.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Cool, muted
                                neutrals are your foundation — avoid warmth.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">02</div>
                            <div>
                                <div class="fi-title">Dusty, romantic accents</div>
                                <div class="fi-desc">Dusty rose, soft lavender, and muted sage in shirts, ties, or pocket
                                    squares add the right amount of summer softness.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Soft, dusty
                                accents add just the right touch.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">03</div>
                            <div>
                                <div class="fi-title">Silver and cool leather</div>
                                <div class="fi-desc">Silver watches, grey or black leather shoes and belts, and brushed
                                    metal accessories. Avoid yellow gold and warm brown leather.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Silver and
                                cool leathers are your accessories.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">04</div>
                            <div>
                                <div class="fi-title">Avoid warm and bright colours</div>
                                <div class="fi-desc">No orange, yellow, bright red, camel, or warm brown. These will clash
                                    dramatically with your cool, muted colouring.</div>
                            </div>
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Warm and
                                bright colours are your enemy — stick to cool muteds.</div>
                        </div>
                    </div>
                </div>
                <div>
            ...
            <div class="outfit-grid">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Light grey suit · Dusty blue shirt · Muted lavender tie · Silver
                            cufflinks · Grey leather oxfords</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Cool,
                        sophisticated, and professionally True Summer.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    <div class="outfit-top" style="background:linear-gradient(145deg,#B0C4DE,#8FA8C8);">🕊️</div>
                    <div class="outfit-body">
                        ...
                        <div class="outfit-items">Dusty blue polo · Cool grey chinos · White trainers · Silver watch</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Casual, cool, and
                ...
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-name">Soft Lavender</div>
                        <div class="outfit-items">Soft lavender sweater · Pale grey jeans · White canvas sneakers · Silver
                            bracelet</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Relaxed, cool, and
                        perfectly True Summer.</div>
                </div>
            </div>
        </section>
    </div>
    ...
    <div id="neutral-content" class="gender-content">
        <section class="season-section">
            ...
            <p class="body-text" style="max-width:560px;margin-bottom:36px;">True Summer is about cool muting, gentle
                softness, and romantic elegance. These principles work for any gender expression.</p>
            <div
                ...
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="fi-desc" style="font-size:14px;">Soft grey, lavender-grey, and cool taupe are your
                        foundation. Avoid warm beige or camel.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Your neutrals are
                        dusty and cool — never warm.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">💜</div>
                    <div class="fi-title">Powder-soft accents</div>
                    <div class="fi-desc" style="font-size:14px;">Dusty rose, lavender, powder blue, and soft sage bring
                        gentle colour without overwhelming your soft features.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Soft, dusty
                        accents add just the right touch of colour.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">⚜️</div>
                    <div class="fi-title">Metallic finishes</div>
                    <div class="fi-desc" style="font-size:14px;">Silver, platinum, white gold, and pewter. Avoid yellow
                ...
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="fi-desc" style="font-size:14px;">Avoid harsh lines, high contrast, or bright colours. Your
                        beauty lives in subtlety.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Softness and
                        subtlety are your signature.</div>
                </div>
            </div>
            <div class="outfit-grid" style="margin-bottom:20px;">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="outfit-body">
                        ...
                        <div class="outfit-name">Soft Grey</div>
                        <div class="outfit-items">Soft grey linen shirt/jacket · Cool taupe trousers · White trainers ·
                            Silver accessories</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A soft, cool
                        unisex look that's effortlessly elegant.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    <div class="outfit-top" style="background:linear-gradient(145deg,#C9A0DC,#B090C8);">💜</div>
                    <div class="outfit-body">
                        <div class="outfit-occasion">Soft Accent</div>
                        <div class="outfit-name">Lavender Layer</div>
                        <div class="outfit-items">Dusty lavender sweater or cardigan · Grey base · Silver chain · Grey
                            canvas shoes</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A soft, romantic
                        layer that's perfectly True Summer.</div>
                </div>
            </div>
        </section>
    </div>
