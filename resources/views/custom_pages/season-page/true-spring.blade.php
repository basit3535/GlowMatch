    ...
    <div class="sp-hero-visual">
      ...
      <div class="sp-visual-badges">
        ...
        <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your skin has a distinct golden warmth — clear and bright, never muted.</div>
        </div>
        <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your colours are clear and vibrant — never dull or greyed.</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="season-section-alt">
    ...
    <div class="three-col">
      <div class="tooltip-trigger card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Warm, golden skin that glows — tans to a beautiful golden colour.</div>
      </div>
      <div class="tooltip-trigger card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Clear, sparkling eyes with golden flecks — bright and vivid.</div>
      </div>
      <div class="tooltip-trigger card" style="position:relative;">
        <div style="font-size:32px;margin-bottom:14px;">💇</div>
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Warm, sunny hair with golden highlights — catches the light beautifully.</div>
      </div>
    </div>
    ...
    <section class="season-section">
      ...
      <div class="makeup-row">
        ...
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Warm, golden-beige base that matches your clear warmth.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#FF8C69;"></div>
          <div class="makeup-label">Warm Salmon</div>
          <div class="makeup-type">Blush</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Warm salmon blush for a fresh, healthy flush.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#FF6347;"></div>
          <div class="makeup-label">Bright Coral</div>
          <div class="makeup-type">Lips</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Your signature lip — bright, warm, and coral.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Warm golden shadow that brings out your eyes.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#FF7F50;"></div>
          <div class="makeup-label">Vivid Coral</div>
          <div class="makeup-type">Lips</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">A bright coral lip that pops with your warmth.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#CD853F;"></div>
          <div class="makeup-label">Warm Bronze</div>
          <div class="makeup-type">Eyes</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Warm bronze shadow for a golden eye look.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#FFA07A;"></div>
          <div class="makeup-label">Light Salmon</div>
          <div class="makeup-type">Blush</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Soft salmon blush for a natural warmth.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Warm gold shimmer for a radiant, sun-kissed glow.</div>
        </div>
      </div>
      <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
        <div class="tooltip-trigger card" style="position:relative;">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Golden, warm bases — a touch of yellow is fine.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Golden warmth is your signature — coral is your best friend.</div>
        </div>
      </div>
    </section>
        ...
        <div>
          ...
          <div class="feature-row">
            <div class="tooltip-trigger feature-item" style="position:relative;">
              ...
              <div><div class="fi-title">Warm, clear colours</div><div class="fi-desc">Your palette is warm AND clear — meaning you can handle brightness. Vivid corals, warm turquoise, and bright yellows are your playground.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Bright, warm colours are your signature — don't be afraid to be vivid.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">02</div>
              <div><div class="fi-title">Mix brights with naturals</div><div class="fi-desc">Pair a vivid coral top with warm camel trousers for a signature True Spring look that feels both bold and natural.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Bright colours grounded by warm neutrals create a balanced look.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Muted colours drain your brightness — stick to clear, warm shades.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">04</div>
              <div><div class="fi-title">Gold jewellery only</div><div class="fi-desc">Yellow gold, rose gold, and brass. Silver and white gold will clash with your warm colouring.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Gold is your metal — silver is too cool for you.</div>
            </div>
          </div>
        </div>
        <div>
          ...
          <div class="avoid-grid">
            ...
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Purple is too cool — choose warm violet or plum.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
            ...
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Hot pink is too cool — choose coral or warm pink.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Black is too harsh — choose charcoal or warm chocolate.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Dark slate is too cool — choose warm olive or teal.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Dark teal is too cool — choose warm aqua or spring green.</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="season-section">
      ...
      <div class="outfit-grid">
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          ...
          <div class="outfit-body"><div class="outfit-occasion">Day</div><div class="outfit-name">Golden Hour Chic</div><div class="outfit-items">Warm yellow sundress · Tan wedge sandals · Woven sun hat · Gold bangles</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Fresh, golden, and perfect for a sunny day.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#FF7F50,#FF6347);">🌺</div>
          <div class="outfit-body"><div class="outfit-occasion">Casual</div><div class="outfit-name">Coral Spring</div><div class="outfit-items">Coral wrap top · White wide-leg jeans · Tan mules · Simple gold hoops</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Bright, casual, and effortlessly warm.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#90EE90,#6BBF6B);">🌿</div>
          <div class="outfit-body"><div class="outfit-occasion">Evening</div><div class="outfit-name">Spring Garden</div><div class="outfit-items">Warm green midi dress · Tan strappy heels · Gold drop earrings · Nude clutch</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Elegant, fresh, and beautifully True Spring.</div>
        </div>
      </div>
    </section>
  </div>
  ...
  <div id="men-content" class="gender-content">
    ...
    <section class="season-section">
      ...
      <div class="makeup-row">
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Warm, golden hydration for a natural glow.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Peachy concealer that blends with your warm skin.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
        ...
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Warm honey-brown oil for a soft, conditioned beard.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#DAA520;"></div>
          <div class="makeup-label">Golden Pomade</div>
          <div class="makeup-type">Hair Styling</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Warm golden pomade for a natural hold.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
      ...
      <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
        <div class="tooltip-trigger card" style="position:relative;">
          ...
          <div class="body-text" style="font-size:14px;">Brightening and radiance. Use vitamin C and gentle exfoliation to keep your naturally golden skin glowing. Avoid heavy, matte, or greyish finishes.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Radiant, glowing skin is your goal — brightening products help.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:14px;font-weight:600;color:#2C2420;margin-bottom:8px;">Facial Hair</div>
          <div class="body-text" style="font-size:14px;">Keep facial hair warm and golden-toned. Use honey brown or golden beard oils. Avoid cool ashy tones or dark black beards that create harsh contrast.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Warm, golden facial hair complements your sunny colouring.</div>
        </div>
      </div>
    </section>
      ...
      <div class="two-col">
        <div>
          ...
          <div class="feature-row">
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">01</div>
              <div><div class="fi-title">Warm, golden neutrals</div><div class="fi-desc">Camel, tan, warm sand, and wheat are your best suit and trouser colours. Avoid charcoal and cool greys.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Warm, golden neutrals are your foundation — they enhance your warmth.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">02</div>
              <div><div class="fi-title">Clear warm accents</div><div class="fi-desc">Coral, golden yellow, warm aqua, and bright green in shirts, polos, or ties add that signature True Spring energy.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Bright, clear accents bring your outfit to life.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">03</div>
              <div><div class="fi-title">Gold and tan leather</div><div class="fi-desc">Gold watches, tan leather shoes and belts, and light wood accessories complement your warm colouring.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Gold and tan leather tie your warm look together.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">04</div>
              <div><div class="fi-title">Avoid cool and dark colours</div><div class="fi-desc">No black, navy, cool grey, or deep purple. They will drain your warmth and make you look sallow.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Cool and dark colours are your enemy — they dull your warmth.</div>
            </div>
          </div>
        </div>
        <div>
          ...
          <div class="avoid-grid">
            ...
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="avoid-info"><div class="avoid-name">Navy</div><div class="avoid-why">Too cool and heavy</div></div>
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Navy is too cool — choose warm olive or teal.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Silver is too cool — choose gold or brass.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              <div class="avoid-swatch" style="background:#FFFFFF;"></div>
              <div class="avoid-info"><div class="avoid-name">Pure White</div><div class="avoid-why">Too harsh, opt for cream</div></div>
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">White is too stark — choose warm cream or ivory.</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="season-section">
      ...
      <div class="outfit-grid">
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#FFD700,#FFA500);">🌞</div>
          <div class="outfit-body"><div class="outfit-occasion">Business</div><div class="outfit-name">Golden Beige Suit</div><div class="outfit-items">Warm beige suit · Coral tie · Cream shirt · Tan oxfords · Gold watch</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Warm, professional, and confident — True Spring business style.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#FF7F50,#FF6347);">🌺</div>
          <div class="outfit-body"><div class="outfit-occasion">Smart Casual</div><div class="outfit-name">Coral & Khaki</div><div class="outfit-items">Coral polo · Warm khaki chinos · Tan suede loafers · Leather strap watch</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Smart, warm, and effortlessly stylish.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#90EE90,#6BBF6B);">🌿</div>
          <div class="outfit-body"><div class="outfit-occasion">Weekend</div><div class="outfit-name">Warm Green</div><div class="outfit-items">Warm green sweater · Cream chinos · Tan boots · Gold chain necklace</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Relaxed, warm, and perfectly True Spring.</div>
        </div>
      </div>
    </section>
  </div>
    ...
    <section class="season-section">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:20px;margin-bottom:32px;">
        <div class="tooltip-trigger card" style="position:relative;">
          ...
          <div class="fi-desc" style="font-size:14px;">Camel, wheat, warm sand, and golden tan are your foundation. Avoid cool greys and harsh whites.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Your neutrals are warm and golden — never cool or stark.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:24px;margin-bottom:8px;">🌺</div>
          <div class="fi-title">Clear, warm accents</div>
          <div class="fi-desc" style="font-size:14px;">Coral, golden yellow, warm turquoise, and bright green bring life to your outfits. Keep colours clear and warm.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Bright, clear accents add the perfect pop of warmth.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:24px;margin-bottom:8px;">⚜️</div>
          <div class="fi-title">Warm metals</div>
          <div class="fi-desc" style="font-size:14px;">Gold, rose gold, and brass. Avoid silver, platinum, or white gold.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Warm metals are your signature — cool metals don't work for you.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:24px;margin-bottom:8px;">🌸</div>
          <div class="fi-title">Keep it bright, not muted</div>
          <div class="fi-desc" style="font-size:14px;">Your colours should look fresh and sunlit. Avoid anything dusty, greyed, or muddy.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Bright, fresh colours are your signature — avoid dullness.</div>
        </div>
      </div>
      <div class="outfit-grid" style="margin-bottom:20px;">
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#FFD700,#FFA500);">🌞</div>
          <div class="outfit-body"><div class="outfit-occasion">Unisex Look</div><div class="outfit-name">Golden Hour</div><div class="outfit-items">Camel coat or jacket · Cream base · Tan boots · Gold jewellery or watch</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A warm, sunny unisex look that radiates spring energy.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#FF7F50,#FF6347);">🌺</div>
          <div class="outfit-body"><div class="outfit-occasion">Bright Accent</div><div class="outfit-name">Coral Pop</div><div class="outfit-items">Coral sweater or hoodie · Warm beige trousers · Tan sneakers · Gold details</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A bold, warm accent that's perfectly True Spring.</div>
        </div>
      </div>
    </section>
  </div>
  ...
  <section class="season-section-alt">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:24px;">
      ...
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her warm golden hair and skin are classic True Spring.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her golden warmth and bright features are True Spring.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her warm, clear colouring is quintessential True Spring.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her bright, warm features are a True Spring icon.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">His warm, golden energy is perfectly True Spring.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        <div class="celeb-avatar" style="background:#FFD700;">🎨</div>
        <div class="celeb-name">Hugh Jackman</div>
        <div class="celeb-note">Warm spring colouring (he/him)</div>
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">His warm, sunny features are a great True Spring example.</div>
      </div>
    </div>
  </section>
