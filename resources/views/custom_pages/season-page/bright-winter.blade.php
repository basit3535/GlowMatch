        ...
        <div class="sp-hero-visual">
            ...
            <div class="sp-visual-badges">
                ...
                <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your skin has a cool, blue-based undertone — never warm or golden.</div>
                </div>
                <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Of all 12 seasons, Bright Winter has the most vivid, saturated palette.</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="season-section-alt">
        ...
        <div class="three-col">
            <div class="tooltip-trigger card" style="position:relative;">
                ...
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Cool, clear skin that glows — never sallow or warm-toned.</div>
            </div>
            <div class="tooltip-trigger card" style="position:relative;">
                ...
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Eyes are often the most memorable feature — bright, sparkling, and clear.</div>
            </div>
            <div class="tooltip-trigger card" style="position:relative;">
                <div style="font-size:32px;margin-bottom:14px;">💇</div>
                ...
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Always cool-toned — no red, gold, or warm highlights.</div>
            </div>
        </div>
        ...
        <section class="season-section">
            ...
            <div class="makeup-row">
                ...
                <div class="tooltip-trigger makeup-item">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Cool, clear base — never warm or yellow-toned.</div>
                </div>
                <div class="tooltip-trigger makeup-item">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">A pop of cool pink that looks natural on Bright Winter.</div>
                </div>
                <div class="tooltip-trigger makeup-item">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Your signature lip — vivid, cool, and attention-grabbing.</div>
                </div>
                <div class="tooltip-trigger makeup-item">
                    <div class="makeup-swatch" style="background:#0040C0;"></div>
                    <div class="makeup-label">Vivid Blue</div>
                    <div class="makeup-type">Eyes</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Electric blue liner or shadow makes your eyes pop.</div>
                </div>
                <div class="tooltip-trigger makeup-item">
                    <div class="makeup-swatch" style="background:#8000FF;"></div>
                    <div class="makeup-label">Electric Violet</div>
                    <div class="makeup-type">Eyes</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Vivid purple that's bold but cool-toned.</div>
                </div>
                <div class="tooltip-trigger makeup-item">
                    <div class="makeup-swatch" style="background:#004080;"></div>
                    <div class="makeup-label">Deep Electric</div>
                    <div class="makeup-type">Eyes</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Deep navy for definition without warmth.</div>
                </div>
                <div class="tooltip-trigger makeup-item">
                    <div class="makeup-swatch" style="background:#FF40A0;"></div>
                    <div class="makeup-label">Hot Cool Pink</div>
                    <div class="makeup-type">Blush</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Bright, cool pink for a lit-from-within glow.</div>
                </div>
                <div class="tooltip-trigger makeup-item">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Cool, silvery shimmer for a radiant finish.</div>
                </div>
            </div>
            <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="body-text" style="font-size:14px;">Cool, clear foundations — similar to True Winter but
                        ...
                        cool-toned.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Look for "cool", "pink", or "neutral-cool" shades — never warm or golden.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="body-text" style="font-size:14px;">Electric and vivid. The brightest, most saturated cool
                        ...
                        made for this.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Don't be afraid of bold colour — it's what makes you shine.</div>
                </div>
            </div>
        </section>
                ...
                <div>
                    ...
                    <div class="feature-row">
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Think: cobalt blue, hot pink, emerald green — never muted.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">High contrast is your superpower — use it boldly.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Most people can't wear neons — but you absolutely can.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Dusty, muted colours will drain your natural vibrancy.</div>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="avoid-grid">
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Warm earth tones clash with your cool, vivid colouring.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Too warm — opt for icy lemon or cool bright yellow instead.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">You need clear, bright pink — not dusty or muted.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Cool grey is your neutral — taupe is too warm.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Avoid all warm browns — they dull your complexion.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Camel is a classic warm neutral — not for Bright Winter.</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="season-section">
            ...
            <div class="outfit-grid">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A perfect daytime look — high contrast, cool, and effortlessly vivid.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your evening look is bold, electric, and unforgettable.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Casual but striking — cyan is one of your most flattering shades.</div>
                </div>
            </div>
        </section>
    </div>
        ...
        <section class="season-section">
            ...
            <div class="makeup-row">
                <div class="tooltip-trigger makeup-item">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Cool, refreshing formulas that brighten your complexion.</div>
                </div>
                <div class="tooltip-trigger makeup-item">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Cool-toned concealer to brighten dark circles.</div>
                </div>
                <div class="tooltip-trigger makeup-item">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Mattifying SPF with a cool, non-greasy finish.</div>
                </div>
                <div class="tooltip-trigger makeup-item">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Soothing gel that calms skin without warming it.</div>
                </div>
                <div class="tooltip-trigger makeup-item">
                    <div class="makeup-swatch" style="background:#0040C0;"></div>
                    <div class="makeup-label">Deep Navy Pomade</div>
                    <div class="makeup-type">Hair Styling</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Cool-toned pomade that adds shine and definition.</div>
                </div>
                <div class="tooltip-trigger makeup-item">
                    <div class="makeup-swatch" style="background:#8000FF;"></div>
                    <div class="makeup-label">Electric Violet (subtle)</div>
                    <div class="makeup-type">Accent (optional)</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">A tiny pop of cool violet for a modern edge.</div>
                </div>
            </div>
            <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="body-text" style="font-size:14px;">Brighten and clarify. Use Vitamin C serums (cool
                        formulas) and ice rollers to enhance your natural vibrancy. Avoid warm, yellow-tinted products.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Look for "brightening", "cooling", or "clarifying" formulas.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="body-text" style="font-size:14px;">Keep facial hair neat and cool-toned. If you have a
                        beard, use a cool blue or silver beard oil to enhance clarity. Avoid reddish or warm brown tones.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Cool-toned beard care keeps your look crisp and clear.</div>
                </div>
            </div>
        </section>
                ...
                <div>
                    ...
                    <div class="feature-row">
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Think: cobalt, icy blue, emerald — never muted or warm.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">02</div>
                            <div>
                            ...
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Light + dark = the Bright Winter signature.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">03</div>
                            <div>
                            ...
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Small pops of neon are powerful on you.</div>
                        </div>
                        <div class="tooltip-trigger feature-item" style="position:relative;">
                            <div class="fi-num">04</div>
                            <div>
                            ...
                            <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Earth tones are your enemy — stick to cool, crisp shades.</div>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="avoid-grid">
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Warm tan makes you look washed out.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#FFD700;"></div>
                            <div class="avoid-info">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Golden yellow clashes with your cool undertone.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#BC8F8F;"></div>
                            <div class="avoid-info">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">You need bright, clear pink — not dusty rose.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#A0917E;"></div>
                            <div class="avoid-info">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Cool grey is your neutral — taupe is wrong.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#8B4513;"></div>
                            <div class="avoid-info">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">All warm browns are out — no exception.</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            <div class="avoid-swatch" style="background:#D2B48C;"></div>
                            <div class="avoid-info">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Camel is too warm and muted for your vivid complexion.</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="season-section">
            ...
            <div class="outfit-grid">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Sharp, modern, and undeniably Bright Winter.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    <div class="outfit-top" style="background:linear-gradient(145deg,#FF0080,#C00060);">💥</div>
                    <div class="outfit-body">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Bold but refined — the perfect evening statement.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    <div class="outfit-top" style="background:linear-gradient(145deg,#00C0FF,#0080C0);">🧊</div>
                    <div class="outfit-body">
                        <div class="outfit-occasion">Casual</div>
                        <div class="outfit-name">Icy Cyan</div>
                        <div class="outfit-items">Vivid cyan polo shirt · Dark grey chinos · White trainers · Silver watch</div>
                    </div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Effortless cool — cyan is your power colour.</div>
                </div>
            </div>
        </section>
    </div>
        ...
        <section class="season-section">
            ...
            <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:20px;margin-bottom:32px;">
                <div class="tooltip-trigger card" style="position:relative;">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Vivid > muted. Always.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">⚡</div>
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Light + dark = your formula for impact.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">💎</div>
                    ...
                    <div class="fi-desc" style="font-size:14px;">Silver, platinum, and chrome finishes work best. Avoid
                        gold or bronze.</div>
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Cool metals only — silver, platinum, chrome.</div>
                </div>
                <div class="tooltip-trigger card" style="position:relative;">
                    <div style="font-size:24px;margin-bottom:8px;">🧊</div>
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Cool neutrals only — keep it crisp and clean.</div>
                </div>
            </div>
            <div class="outfit-grid" style="margin-bottom:20px;">
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A universally flattering Bright Winter staple.</div>
                </div>
                <div class="tooltip-trigger outfit-card" style="position:relative;">
                    <div class="outfit-top" style="background:linear-gradient(145deg,#FF0080,#C00060);">💥</div>
                    <div class="outfit-body">
                    ...
                    <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">One bold accessory can transform any outfit.</div>
                </div>
            </div>
        </section>
    </div>
    ...
    <section class="season-section-alt">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:24px;">
            ...
            <div class="tooltip-trigger celeb-card" style="position:relative;">
                ...
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Iconic Bright Winter — her violet eyes and dark hair defined the season.</div>
            </div>
            <div class="tooltip-trigger celeb-card" style="position:relative;">
                ...
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Bold, vivid, and unapologetically bright — a modern Bright Winter.</div>
            </div>
            <div class="tooltip-trigger celeb-card" style="position:relative;">
                ...
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her dark hair and bright blue eyes are classic Bright Winter.</div>
            </div>
            <div class="tooltip-trigger celeb-card" style="position:relative;">
                ...
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">High contrast, cool, and striking — a Bright Winter archetype.</div>
            </div>
            <div class="tooltip-trigger celeb-card" style="position:relative;">
                <div class="celeb-avatar" style="background:#0040C0;">🎸</div>
                <div class="celeb-name">Harry Styles</div>
                <div class="celeb-note">Bright Winter energy (he/they)</div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Plays with vivid colour and high contrast — quintessential Bright Winter.</div>
            </div>
            <div class="tooltip-trigger celeb-card" style="position:relative;">
                <div class="celeb-avatar" style="background:#8000FF;">🎬</div>
                <div class="celeb-name">Robert Downey Jr.</div>
                <div class="celeb-note">Vivid cool contrast (he/him)</div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Sharp, clear features with cool-toned charisma.</div>
            </div>
            <div class="tooltip-trigger celeb-card" style="position:relative;">
                <div class="celeb-avatar" style="background:#0060C0;">✨</div>
                <div class="celeb-name">Tilda Swinton</div>
                <div class="celeb-note">Ethereal bright winter (she/they)</div>
                <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Cool, pale, and striking — an otherworldly Bright Winter.</div>
            </div>
        </div>
    </section>
    ...
    <script>
        (function() {
            ...
            function setGender(gender) {
                ...
                if (gender === 'women') { women.classList.add('active-gender');
                    btns[0].classList.add('active'); } else if (gender === 'men') { men.classList.add('active-gender');
                    btns[1].classList.add('active'); } else { neutral.classList.add('active-gender');
