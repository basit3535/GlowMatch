...
@section('content')
  ...
  <!-- MAKEUP -->
  <section class="season-section">
    <span class="lbl" style="color:#6878B4;">✦ Makeup Guide</span>
  ...
  <section class="season-section-alt">
    <div class="two-col">
      <div>
        <span class="lbl" style="color:#6878B4;">✦ Wardrobe Tips</span>
        <div class="h2" style="margin-bottom:20px;">How to dress as a Light Summer</div>
  ...
  <!-- OUTFIT IDEAS -->
  <section class="season-section">
    <span class="lbl" style="color:#6878B4;">✦ Outfit Inspiration</span>
    <div class="h2" style="margin-bottom:36px;">Looks built for Light Summer</div>
    <div class="outfit-grid">
      <div class="outfit-card">
        ...
        <div class="outfit-body">
          ...
          <div class="outfit-items">Powder blue silk blouse · Pale grey trousers · Silver ballet flats · Pearl earrings</div>
        </div>
      </div>
      <div class="outfit-card">
        ...
        <div class="outfit-body">
          ...
          <div class="outfit-items">Soft lilac knit · Light grey jeans · White sneakers · Delicate silver necklace</div>
        </div>
      </div>
      <div class="outfit-card">
        ...
        <div class="outfit-body">
          ...
          <div class="outfit-items">Pale blue-grey dress · Silver strappy heels · Silver evening bag · Diamond studs</div>
        </div>
      </div>
    </div>
  </section>
