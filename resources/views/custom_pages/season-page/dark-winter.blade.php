    ...
    <div class="sp-hero-visual">
      ...
      <div class="sp-visual-badges">
        ...
        <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your skin has a distinct coolness, even in deep tones — never warm or golden.</div>
        </div>
        <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your overall colouring is the darkest of all seasons — near-black tones are your best.</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="season-section-alt">
    ...
    <div class="three-col">
      <div class="tooltip-trigger card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Cool, deep, and striking — never warm or ashy.</div>
      </div>
      <div class="tooltip-trigger card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Deep and penetrating — eyes are often your most memorable feature.</div>
      </div>
      <div class="tooltip-trigger card" style="position:relative;">
        <div style="font-size:32px;margin-bottom:14px;">💇</div>
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">The darkest, coolest hair — no red or golden undertones.</div>
      </div>
    </div>
    ...
    <section class="season-section">
      ...
      <div class="makeup-row">
        ...
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Deep, cool-toned base — never warm or golden.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#6A3050;"></div>
          <div class="makeup-label">Deep Berry</div>
          <div class="makeup-type">Blush</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Cool, deep berry that adds drama without warmth.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#5A1040;"></div>
          <div class="makeup-label">Dark Plum</div>
          <div class="makeup-type">Lips</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Your signature lip — deep, cool, and intensely dramatic.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#1A2848;"></div>
          <div class="makeup-label">Deep Navy</div>
          <div class="makeup-type">Eyes</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Navy liner or shadow that enhances your cool depth.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#2A1038;"></div>
          <div class="makeup-label">Dark Violet</div>
          <div class="makeup-type">Eyes</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Cool violet for a hauntingly beautiful effect.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#301840;"></div>
          <div class="makeup-label">Deep Purple</div>
          <div class="makeup-type">Eyes</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Rich purple that's dark and cool — never warm.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#4A1830;"></div>
          <div class="makeup-label">Cool Burgundy</div>
          <div class="makeup-type">Blush</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Cool, deep burgundy blush for a striking look.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Cool, silver shimmer — never gold or warm.</div>
        </div>
      </div>
      <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
        <div class="tooltip-trigger card" style="position:relative;">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Look for "cool", "neutral-cool", or "rosy" — never warm or golden.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Embrace the darkest, coolest versions of every product.</div>
        </div>
      </div>
    </section>
        ...
        <div>
          ...
          <div class="feature-row">
            <div class="tooltip-trigger feature-item" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">These are your power neutrals — they enhance your natural depth.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Deep jewel tones match your dramatic intensity perfectly.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Black is a neutral for you — wear it confidently.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Silver, platinum, and white gold are your metals — never gold.</div>
            </div>
          </div>
        </div>
        <div>
          ...
          <div class="avoid-grid">
            ...
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Orange is the opposite of your cool, dark colouring.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Yellow is too bright and warm for your deep coolness.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Warm brown fights with your cool depth — choose charcoal instead.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Beige is too warm and light — stick to icy white or charcoal.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Choose dark forest green or teal instead.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Deep burgundy or plum are your pinks — not pastels.</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="season-section">
      ...
      <div class="outfit-grid">
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          ...
          <div class="outfit-body"><div class="outfit-occasion">Day</div><div class="outfit-name">Dark Sovereign</div><div class="outfit-items">Deep navy structured coat · Charcoal trousers · Black leather shoes · Silver watch</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Powerful, cool, and commanding — perfect for daytime drama.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#3A1818,#2A1020);">💎</div>
          <div class="outfit-body"><div class="outfit-occasion">Evening</div><div class="outfit-name">Midnight Plum</div><div class="outfit-items">Deep plum silk dress · Black pointed heels · Silver evening bag · Amethyst jewellery</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Elegant, mysterious, and deeply cool — your evening signature.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#102030,#0A1828);">❄️</div>
          <div class="outfit-body"><div class="outfit-occasion">Formal</div><div class="outfit-name">Deep Ocean</div><div class="outfit-items">Dark teal-navy blazer · Near-black trousers · Black patent shoes · Cool sapphire cufflinks</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Sharp, dark, and impeccably cool — formalwear at its best.</div>
        </div>
      </div>
    </section>
  </div>
  ...
  <div id="men-content" class="gender-content">
    ...
    <section class="season-section">
      ...
      <div class="makeup-row">
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Cool, mattifying formula that controls shine without warmth.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Cool-toned concealer for dark circles — never warm.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Tinted SPF with a cool, non-ashy finish.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Charcoal-infused oil that cools and conditions.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Navy-tinted pomade for a cool, sharp look.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Cool plum brow gel for definition without warmth.</div>
        </div>
      </div>
      <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:14px;font-weight:600;color:#2C2420;margin-bottom:8px;">Skincare Focus</div>
          <div class="body-text" style="font-size:14px;">Clarity and coolness. Use cooling gels, ice rollers, and products that minimise redness or warmth. Avoid self-tanners with warm/orange undertones.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Cooling, clarifying products keep your complexion sharp.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:14px;font-weight:600;color:#2C2420;margin-bottom:8px;">Facial Hair</div>
          <div class="body-text" style="font-size:14px;">Keep facial hair neat and cool-toned. Use a charcoal or cool grey beard oil. Avoid any reddish or warm brown tones. A sharp, clean line enhances your dramatic contrast.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Cool-toned beard care maintains your dramatic edge.</div>
        </div>
      </div>
    </section>
      ...
      <div class="two-col">
        <div>
          ...
          <div class="feature-row">
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">01</div>
              <div><div class="fi-title">Deep, dark neutrals</div><div class="fi-desc">Navy, charcoal, near-black, and deep teal are your core suit and trouser colours. Black is genuinely excellent for you.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">These neutrals are your foundation — dark and cool.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">02</div>
              <div><div class="fi-title">Cool jewel-tone accents</div><div class="fi-desc">Deep burgundy ties, dark plum pocket squares, or cool sapphire accessories add drama without losing the dark intensity.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Accents that are deep and cool, never bright or warm.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">03</div>
              <div><div class="fi-title">Silver over gold</div><div class="fi-desc">Silver watches, platinum rings, and cool chrome hardware. Avoid yellow gold and bronze entirely.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Silver, platinum, and chrome are your metals.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">04</div>
              <div><div class="fi-title">Avoid warm and light colours</div><div class="fi-desc">No camel, tan, warm brown, pastels, or earthy warm tones. They will drain your dramatic intensity.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Warm tones clash with your cool depth — avoid them completely.</div>
            </div>
          </div>
        </div>
        <div>
          ...
          <div class="avoid-grid">
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              <div class="avoid-swatch" style="background:#FF6600;"></div>
              <div class="avoid-info"><div class="avoid-name">Orange</div><div class="avoid-why">Too warm, clashes dramatically</div></div>
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Orange is the opposite of your cool, dark palette.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              <div class="avoid-swatch" style="background:#FFD700;"></div>
              <div class="avoid-info"><div class="avoid-name">Yellow</div><div class="avoid-why">Too warm and light</div></div>
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Yellow is too bright and warm for your depth.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              <div class="avoid-swatch" style="background:#C8A070;"></div>
              <div class="avoid-info"><div class="avoid-name">Warm Brown</div><div class="avoid-why">Undertone mismatch</div></div>
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Warm brown doesn't work — choose charcoal or navy.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              <div class="avoid-swatch" style="background:#F5DEB3;"></div>
              <div class="avoid-info"><div class="avoid-name">Warm Beige</div><div class="avoid-why">Too light and warm</div></div>
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Beige is too warm and light — icy white or charcoal are better.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              <div class="avoid-swatch" style="background:#90EE90;"></div>
              <div class="avoid-info"><div class="avoid-name">Light Green</div><div class="avoid-why">Too light and warm-toned</div></div>
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Dark forest green or teal suit you better.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              <div class="avoid-swatch" style="background:#FFC0CB;"></div>
              <div class="avoid-info"><div class="avoid-name">Pastel Pink</div><div class="avoid-why">Too light, wrong undertone</div></div>
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Deep burgundy or plum are your pinks.</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="season-section">
      ...
      <div class="outfit-grid">
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#1C2848,#101828);">🌑</div>
          <div class="outfit-body"><div class="outfit-occasion">Business</div><div class="outfit-name">Midnight Navy</div><div class="outfit-items">Deep navy suit · White or icy grey shirt · Deep plum tie · Silver cufflinks</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Powerful, cool, and commanding — perfect for the boardroom.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#3A1818,#2A1020);">💎</div>
          <div class="outfit-body"><div class="outfit-occasion">Smart Casual</div><div class="outfit-name">Dark Burgundy Edge</div><div class="outfit-items">Charcoal trousers · Deep burgundy sweater · Black leather boots · Silver watch</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Sophisticated, cool, and effortlessly dramatic.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#102030,#0A1828);">❄️</div>
          <div class="outfit-body"><div class="outfit-occasion">Formal</div><div class="outfit-name">Black & Silver</div><div class="outfit-items">Black tuxedo · White shirt · Dark navy pocket square · Silver accessories</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">The ultimate Dark Winter formal — sharp, dark, and impeccably cool.</div>
        </div>
      </div>
    </section>
  </div>
    ...
    <section class="season-section">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:20px;margin-bottom:32px;">
        <div class="tooltip-trigger card" style="position:relative;">
          ...
          <div class="fi-desc" style="font-size:14px;">Black, dark navy, charcoal, and deep plum are your anchors. Build every outfit around these powerful dark tones.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Your neutrals are as dark as they come — own it.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:24px;margin-bottom:8px;">💎</div>
          <div class="fi-title">Deep jewel accents</div>
          <div class="fi-desc" style="font-size:14px;">Use dark sapphire, deep emerald, or rich burgundy as statement colours in accessories or layers.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">These accents add drama without losing the dark vibe.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:24px;margin-bottom:8px;">⚜️</div>
          <div class="fi-title">Metallic finishes</div>
          <div class="fi-desc" style="font-size:14px;">Silver, platinum, chrome, and white gold only. Avoid all warm metals like gold, brass, or copper.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Cool metals only — they enhance your cool depth.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:24px;margin-bottom:8px;">❄️</div>
          <div class="fi-title">One light accent allowed</div>
          <div class="fi-desc" style="font-size:14px;">Icy white or cool pale grey can be used sparingly for contrast, but keep the overall look dark.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Use light accents sparingly — the drama is in the dark.</div>
        </div>
      </div>
      <div class="outfit-grid" style="margin-bottom:20px;">
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#1C2848,#101828);">🌑</div>
          <div class="outfit-body"><div class="outfit-occasion">Unisex Look</div><div class="outfit-name">Dark Power</div><div class="outfit-items">Black or deep navy oversized coat · Charcoal trousers · Silver accessories · Black boots or sneakers</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A powerful, gender-neutral dark winter staple.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#3A1818,#2A1020);">💎</div>
          <div class="outfit-body"><div class="outfit-occasion">Statement Layer</div><div class="outfit-name">Plum Drama</div><div class="outfit-items">Deep plum jacket or sweater · Dark denim or trousers · Silver jewellery or watch</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A bold layer that commands attention with cool depth.</div>
        </div>
      </div>
    </section>
  </div>
  ...
  <section class="season-section-alt">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:24px;">
      ...
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her deep, cool features are quintessential Dark Winter.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Striking dark winter beauty with cool depth.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her dark hair and cool eyes define Dark Winter.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Deep, cool, and dramatic — a Dark Winter icon.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        <div class="celeb-avatar" style="background:#1C2848;">🎭</div>
        <div class="celeb-name">Keanu Reeves</div>
        <div class="celeb-note">Cool dark intensity (he/him)</div>
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">His cool, dark features are a perfect Dark Winter match.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        <div class="celeb-avatar" style="background:#2A1020;">🎸</div>
        <div class="celeb-name">Jon Bon Jovi</div>
        <div class="celeb-note">Dark winter rock (he/him)</div>
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Dark, cool, and charismatic — a rock star Dark Winter.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her deep, cool voice and style embody Dark Winter.</div>
      </div>
    </div>
  </section>
