        ...
        <div>
            <div class="sp-eyebrow">
                ...
                <span class="sp-season-type"
                    style="color:#4860C0;">{{ $data->content->season_hero_eyebrow_label->value ?? '' }}</span>
            </div>
        ...
        <div class="sp-hero-visual">
            ...
            <div class="sp-visual-badges">
                ...
                <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
                    ...
                    <div>
                        <div class="sp-badge-title" style="color:#C0C8E0;">
                            {{ $data->content->season_badge1_title->value ?? '' }}</div>
                        <div class="sp-badge-sub" style="color:#C0C8E0;">
    ...
    <div id="women-content" class="gender-content active-gender">
        ...
        <section class="season-section-alt">
            <div class="two-col">
                <div>
                    <span class="lbl"
                        style="color:#4860C0;">{{ $data->content->wardrobe_women_label->value ?? '' }}</span>
                ...
                <div>
                    ...
                    <div class="avoid-grid">
                        ...
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">
                                {{ $data->content->avoid_warm_beige_tooltip->value ?? '' }}</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">
                                {{ $data->content->avoid_light_green_tooltip->value ?? '' }}</div>
                        </div>
                        <div class="tooltip-trigger avoid-card" style="position:relative;">
                            ...
                            <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">
                                {{ $data->content->avoid_pastel_pink_tooltip->value ?? '' }}</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="men-content" class="gender-content">
        ...
        <section class="season-section-alt">
            <div class="two-col">
                <div>
                    <span class="lbl"
                        style="color:#4860C0;">{{ $data->content->wardrobe_men_label->value ?? '' }}</span>
