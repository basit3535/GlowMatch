...
@section('content')
    ...
    <div class="sp-hero-visual">
      ...
      <div class="sp-visual-badges">
        ...
        <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your undertone is subtly cool but very close to neutral — hard to pin down.</div>
        </div>
        <div class="tooltip-trigger sp-badge" style="background:rgba(255,255,255,.12);">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Your palette is the most greyed and blended — nothing vivid or harsh.</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="season-section-alt">
    ...
    <div class="three-col">
      <div class="tooltip-trigger card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Neutral-cool and muted — your skin is beautifully blended.</div>
      </div>
      <div class="tooltip-trigger card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Soft, greyed, and blended — never sharp or vivid.</div>
      </div>
      <div class="tooltip-trigger card" style="position:relative;">
        <div style="font-size:32px;margin-bottom:14px;">💇</div>
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:220px;">Low-contrast, muted, and neutral — never too warm or too cool.</div>
      </div>
    </div>
    ...
    <section class="season-section">
      ...
      <div class="makeup-row">
        ...
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Neutral, muted base — neither warm nor cool.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#C0A8A8;"></div>
          <div class="makeup-label">Muted Rose</div>
          <div class="makeup-type">Blush</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Soft, greyed rose for a natural hint of colour.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Your perfect everyday lip — muted and blended.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#A0A0B0;"></div>
          <div class="makeup-label">Soft Grey</div>
          <div class="makeup-type">Eyes</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Subtle grey shadow that defines without contrast.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#989898;"></div>
          <div class="makeup-label">Neutral Taupe</div>
          <div class="makeup-type">Eyes</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Warm-grey taupe for a natural eye look.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#B8B0A8;"></div>
          <div class="makeup-label">Warm Grey</div>
          <div class="makeup-type">Eyes</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">A warm grey that blends perfectly with your skin.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#C8C0B8;"></div>
          <div class="makeup-label">Dusty Pink-Grey</div>
          <div class="makeup-type">Blush</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">A barely-there pink-grey for a soft flush.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Cool, muted highlight — never sparkly.</div>
        </div>
      </div>
      <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
        <div class="tooltip-trigger card" style="position:relative;">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Neutral-cool is the key — avoid strong pink or yellow.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Less is more — everything should be barely visible.</div>
        </div>
      </div>
    </section>
        ...
        <div>
          ...
          <div class="feature-row">
            <div class="tooltip-trigger feature-item" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Grey is your best neutral — it harmonises with your muted colouring.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Soft, greyed versions of colours are your sweet spot.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Low contrast is key — keep your outfit values close.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Tonal looks in greyed colours are your signature style.</div>
            </div>
          </div>
        </div>
        <div>
          ...
          <div class="avoid-grid">
            ...
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Orange is too warm and vivid — it overwhelms you.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Yellow is too bright — choose muted mustard or greige.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
            ...
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">White is too stark — choose off-white or warm cream.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Red is too vivid — choose muted brick or dusty rose.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Strong green is too vivid — choose sage or muted olive.</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="season-section">
      ...
      <div class="outfit-grid">
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          ...
          <div class="outfit-body"><div class="outfit-occasion">Day</div><div class="outfit-name">Morning Mist</div><div class="outfit-items">Soft grey linen blazer · Blued grey trousers · Light taupe loafers · Silver minimalist watch</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Cool, sophisticated, and perfectly Soft Summer.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#B0A8A0,#A09898);">🕊️</div>
          <div class="outfit-body"><div class="outfit-occasion">Casual</div><div class="outfit-name">Blended Neutral</div><div class="outfit-items">Muted sage knit top · Warm grey jeans · Grey canvas sneakers · Dainty silver jewellery</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Soft, relaxed, and effortlessly blended.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#989090,#808888);">🌙</div>
          <div class="outfit-body"><div class="outfit-occasion">Evening</div><div class="outfit-name">Soft Dusk</div><div class="outfit-items">Dusty mauve midi dress · Nude-grey strappy heels · Grey evening bag · Pearl jewellery</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Elegant, muted, and beautifully understated.</div>
        </div>
      </div>
    </section>
  </div>
  ...
  <div id="men-content" class="gender-content">
    ...
    <section class="season-section">
      ...
      <p class="body-text" style="max-width:560px;margin-bottom:36px;">Understated, neutral, and natural. Your grooming should enhance your soft, blended colouring without adding contrast.</p>
      <div class="makeup-row">
        <div class="tooltip-trigger makeup-item">
          <div class="makeup-swatch" style="background:#D8D4D0;"></div>
          <div class="makeup-label">Neutral Tinted Moisturizer</div>
          <div class="makeup-type">Skincare</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Light, neutral hydration for a natural finish.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Neutral concealer that blends seamlessly.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Tinted SPF with a neutral, non-ashy finish.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Soft taupe oil for a natural beard.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Grey-toned pomade for a subtle hold.</div>
        </div>
        <div class="tooltip-trigger makeup-item">
          ...
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:170px;">Soft, ash-toned gel for natural brows.</div>
        </div>
      </div>
      <div style="margin-top:28px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:14px;font-weight:600;color:#2C2420;margin-bottom:8px;">Skincare Focus</div>
          <div class="body-text" style="font-size:14px;">Balance and evenness. Use gentle, neutral-toned products that don't add warmth or coolness. Avoid self-tanners or anything that creates high contrast.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Neutral, balanced skincare enhances your natural softness.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:14px;font-weight:600;color:#2C2420;margin-bottom:8px;">Facial Hair</div>
          <div class="body-text" style="font-size:14px;">Keep facial hair soft and low-contrast. Use neutral taupe or ash-toned beard oils. Avoid strong colours (warm reds or cool blacks) that would clash with your muted palette.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Soft, neutral facial hair keeps your look harmonious.</div>
        </div>
      </div>
    </section>
      ...
      <div class="two-col">
        <div>
          ...
          <div class="feature-row">
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">01</div>
              <div><div class="fi-title">Grey is your best suit colour</div><div class="fi-desc">All shades of grey — from light grey to charcoal (not black) — are your most flattering suiting choices. Avoid navy and black.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Grey suits you best — from light to charcoal.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">02</div>
              <div><div class="fi-title">Muted blues and greens</div><div class="fi-desc">Dusty blue, muted teal, and sage green in shirts, polos, or sweaters add subtle colour without overwhelming.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Soft, greyed blues and greens add perfect subtle colour.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">03</div>
              <div><div class="fi-title">Silver and grey leather</div><div class="fi-desc">Silver watches, grey leather shoes and belts, and brushed metal accessories. Avoid yellow gold and dark brown.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Silver and grey leather harmonise with your muted palette.</div>
            </div>
            <div class="tooltip-trigger feature-item" style="position:relative;">
              <div class="fi-num">04</div>
              <div><div class="fi-title">Avoid high-contrast pairings</div><div class="fi-desc">Don't wear black with white, or very dark with very light. Stay within a narrow value range for the most harmonious look.</div></div>
              <div class="tooltip-box tooltip-right" style="white-space:normal;max-width:200px;">Low contrast is key — keep your outfit values close.</div>
            </div>
          </div>
        </div>
        <div>
          ...
          <div class="avoid-grid">
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              <div class="avoid-swatch" style="background:#FF6600;"></div>
              <div class="avoid-info"><div class="avoid-name">Bright Orange</div><div class="avoid-why">Too vivid and warm</div></div>
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Orange is too vivid — choose muted terracotta.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              <div class="avoid-swatch" style="background:#FFD700;"></div>
              <div class="avoid-info"><div class="avoid-name">Bright Yellow</div><div class="avoid-why">Too saturated, too warm</div></div>
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Yellow is too bright — choose muted mustard.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              <div class="avoid-swatch" style="background:#000000;"></div>
              <div class="avoid-info"><div class="avoid-name">Black</div><div class="avoid-why">Too harsh for your soft tones</div></div>
            ...
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              ...
              <div class="avoid-info"><div class="avoid-name">Navy</div><div class="avoid-why">Too cool and dark</div></div>
              <div class="tooltip-box tooltip-left" style="white-space:normal;max-width:160px;">Navy is too dark and cool — choose muted blue.</div>
            </div>
            <div class="tooltip-trigger avoid-card" style="position:relative;">
              <div class="avoid-swatch" style="background:#006400;"></div>
              <div class="avoid-info"><div class="avoid-name">Strong Green</div><div class="avoid-why">Too saturated for your palette</div></div>
    ...
    <section class="season-section">
      ...
      <div class="outfit-grid">
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#C0C8D4,#A8B0BC);">🌫️</div>
          <div class="outfit-body"><div class="outfit-occasion">Business</div><div class="outfit-name">Grey Flannel</div><div class="outfit-items">Mid-grey suit · Dusty blue shirt · Muted sage tie · Silver tie bar · Grey leather oxfords</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Sophisticated, muted, and perfectly Soft Summer.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#B0A8A0,#A09898);">🕊️</div>
          <div class="outfit-body"><div class="outfit-occasion">Smart Casual</div><div class="outfit-name">Muted Teal</div><div class="outfit-items">Muted teal sweater · Warm grey chinos · Grey suede sneakers · Silver watch</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Modern, understated, and effortlessly stylish.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#989090,#808888);">🌙</div>
          <div class="outfit-body"><div class="outfit-occasion">Weekend</div><div class="outfit-name">Soft Dusk</div><div class="outfit-items">Dusty lavender polo · Light grey jeans · Grey canvas trainers · Brushed metal bracelet</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">Relaxed, cool, and perfectly Soft Summer.</div>
        </div>
      </div>
    </section>
  </div>
  ...
  <div id="neutral-content" class="gender-content">
    <section class="season-section">
      ...
      <p class="body-text" style="max-width:560px;margin-bottom:36px;">Soft Summer is about muted harmony, gentle blending, and sophisticated understatement. These principles work for any gender expression.</p>
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:20px;margin-bottom:32px;">
        <div class="tooltip-trigger card" style="position:relative;">
          ...
          <div class="fi-desc" style="font-size:14px;">All shades of grey — warm, cool, blue-grey, taupe-grey — are your most flattering neutrals. Build every outfit around them.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Grey is your most powerful neutral — use it as your base.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:24px;margin-bottom:8px;">🎨</div>
          <div class="fi-title">Muted, blended colours</div>
          <div class="fi-desc" style="font-size:14px;">Dusty rose, sage green, muted blue, and soft lavender — always with a greyed quality. Nothing bright or clear.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Soft, greyed colours are your signature — never bright.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:24px;margin-bottom:8px;">⚜️</div>
          <div class="fi-title">Metallic finishes</div>
          <div class="fi-desc" style="font-size:14px;">Silver, platinum, white gold, and brushed steel. Avoid yellow gold, copper, or bronze.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Cool metals only — they complement your muted palette.</div>
        </div>
        <div class="tooltip-trigger card" style="position:relative;">
          <div style="font-size:24px;margin-bottom:8px;">🕊️</div>
          <div class="fi-title">Low contrast is key</div>
          <div class="fi-desc" style="font-size:14px;">Keep your outfit within a narrow value range. Avoid pairing very light with very dark — aim for soft, tonal looks.</div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Low contrast outfits look most harmonious on you.</div>
        </div>
      </div>
      <div class="outfit-grid" style="margin-bottom:20px;">
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#C0C8D4,#A8B0BC);">🌫️</div>
          <div class="outfit-body"><div class="outfit-occasion">Unisex Look</div><div class="outfit-name">Soft Grey Layer</div><div class="outfit-items">Warm grey sweater or hoodie · Blued grey trousers · White-grey trainers · Silver chain</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A versatile, muted unisex look that feels effortlessly elegant.</div>
        </div>
        <div class="tooltip-trigger outfit-card" style="position:relative;">
          <div class="outfit-top" style="background:linear-gradient(145deg,#B0A8A0,#A09898);">🕊️</div>
          <div class="outfit-body"><div class="outfit-occasion">Tonal Accent</div><div class="outfit-name">Dusty Blue</div><div class="outfit-items">Muted blue shirt or top · Taupe-grey trousers · Grey canvas shoes · Minimal silver jewellery</div></div>
          <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:200px;">A soft, tonal look that's subtle and sophisticated.</div>
        </div>
      </div>
    </section>
  </div>
  ...
  <section class="season-section-alt">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:24px;">
      ...
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her versatile, muted beauty is classic Soft Summer.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her elegant, understated colouring is Soft Summer.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her soft, neutral features are quintessential Soft Summer.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        ...
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her neutral-cool colouring is a perfect Soft Summer match.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        <div class="celeb-avatar" style="background:#C0C8D4;">🎸</div>
        <div class="celeb-name">Steve Carell</div>
        <div class="celeb-note">Soft muted colouring (he/him)</div>
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">His soft, approachable features are Soft Summer.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        <div class="celeb-avatar" style="background:#B8C0CC;">🎭</div>
        <div class="celeb-name">Colin Firth</div>
        <div class="celeb-note">Neutral summer elegance (he/him)</div>
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">His classic, understated elegance defines Soft Summer.</div>
      </div>
      <div class="tooltip-trigger celeb-card" style="position:relative;">
        <div class="celeb-avatar" style="background:#A8B0BC;">🎨</div>
        <div class="celeb-name">Kate Middleton</div>
        <div class="celeb-note">Soft summer style icon (she/her)</div>
        <div class="tooltip-box tooltip-bottom" style="white-space:normal;max-width:180px;">Her sophisticated, muted style is a modern Soft Summer icon.</div>
      </div>
    </div>
  </section>
