...
@section('content')
  ...
  <!-- MAKEUP -->
  <section class="season-section">
    <span class="lbl" style="color:#C97B3A;">✦ Makeup Guide</span>
  ...
  <section class="season-section-alt">
    <div class="two-col">
      <div>
        <span class="lbl" style="color:#C97B3A;">✦ Wardrobe Tips</span>
        <div class="h2" style="margin-bottom:20px;">How to dress as a Light Spring</div>
  ...
  <!-- OUTFIT IDEAS -->
  <section class="season-section">
    <span class="lbl" style="color:#C97B3A;">✦ Outfit Inspiration</span>
    <div class="h2" style="margin-bottom:36px;">Looks built for Light Spring</div>
    <div class="outfit-grid">
      <div class="outfit-card">
        ...
        <div class="outfit-body">
          ...
          <div class="outfit-items">Warm ivory linen top · Camel wide-leg trousers · Gold sandals · Woven bag</div>
        </div>
      </div>
      <div class="outfit-card">
        ...
        <div class="outfit-body">
          ...
          <div class="outfit-items">Floral blouse in peach and cream · Light denim · Tan mules · Dainty gold earrings</div>
        </div>
      </div>
      <div class="outfit-card">
        ...
        <div class="outfit-body">
          ...
          <div class="outfit-items">Rust-orange midi dress · Strappy gold heels · Small gold clutch · Delicate necklace</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="season-section-alt">
    ...
    <div class="celeb-grid">
      <div class="celeb-card">
        ...
        <div class="celeb-note">Light warm colouring</div>
      </div>
      <div class="celeb-card">
