        ...
        <div class="season-cards-grid" id="season-cards-grid">
            ...
            <a href="{{ route('show.seasons.custom_pages', ['slug' => 'true-spring']) }}">
                <div class="season-hub-card" data-group="spring">
                    ...
                    <div class="shc-body">
                        <div class="shc-desc">The classic spring — vibrant, warm, and clear. You radiate in bright corals,
                            warm
            ...
            <a href="{{ route('show.seasons.custom_pages', ['slug' => 'light-summer']) }}">
                <div class="season-hub-card" data-group="summer">
                    ...
                    <div class="shc-body">
                        <div class="shc-desc">The most delicate summer — soft, cool, and light as a morning mist. Your
                            colours
            ...
            <a href="{{ route('show.seasons.custom_pages', ['slug' => 'true-summer']) }}">
                <div class="season-hub-card" data-group="summer">
                    ...
                    <div class="shc-body">
                        <div class="shc-desc">The classic summer — cool, muted, and romantically understated. Dusty rose
                            and
            ...
            <a href="{{ route('show.seasons.custom_pages', ['slug' => 'soft-summer']) }}">
                <div class="season-hub-card" data-group="summer">
                    ...
                    <div class="shc-body">
                        <div class="shc-desc">Where summer meets autumn — soft, blended, and neutrally cool. Your palette
                            is
            ...
            <a href="{{ route('show.seasons.custom_pages', ['slug' => 'soft-autumn']) }}">
                <div class="season-hub-card" data-group="autumn">
                    ...
                    <div class="shc-body">
                        <div class="shc-desc">The most gentle autumn — softly warm and beautifully muted. Your look is
                            natural
            ...
            <a href="{{ route('show.seasons.custom_pages', ['slug' => 'true-autumn']) }}">
                <div class="season-hub-card" data-group="autumn">
                    ...
                    <div class="shc-body">
                        <div class="shc-desc">The classic autumn — the most warm, earthy, and richly natural of all
                            seasons.
            ...
            <a href="{{ route('show.seasons.custom_pages', ['slug' => 'dark-autumn']) }}">
                <div class="season-hub-card" data-group="autumn">
                    ...
                    <div class="shc-body">
                        <div class="shc-desc">Where autumn meets winter — deep, rich, and powerfully warm. The darkest and
                            most
            ...
            <a href="{{ route('show.seasons.custom_pages', ['slug' => 'dark-winter']) }}">
                <div class="season-hub-card" data-group="winter">
                    ...
                    <div class="shc-body">
                        <div class="shc-desc">Where winter meets autumn — the deepest and most dramatic season. Your
                            colours
            ...
            <a href="{{ route('show.seasons.custom_pages', ['slug' => 'true-winter']) }}">
                <div class="season-hub-card" data-group="winter">
                    ...
                    <div class="shc-body">
                        <div class="shc-desc">The classic winter — cool, clear, and strikingly high-contrast. Jewel tones
                            and
            ...
            <a href="{{ route('show.seasons.custom_pages', ['slug' => 'bright-winter']) }}">
                <div class="season-hub-card" data-group="winter">
                    ...
                    <div class="shc-body">
                        <div class="shc-desc">Where winter meets spring — clear, cool, and vibrantly bright. Electric hues
                            and
