        ...
        <div style="display:flex; flex-direction:column; gap:14px;">
            <div style="display:flex; justify-content:space-between; align-items:flex-start;">
                ...
                <button id="cookie-dismiss"
                    style="background:transparent; border:none; font-size:22px; line-height:1; color:#8A7A6A; cursor:pointer; padding:0 4px; transition:color 0.2s;">&times;</button>
            </div>
            ...
            <div style="display:flex; gap:10px; flex-wrap:wrap; margin-top:6px;">
                <button id="cookie-accept"
                    style="flex:1; background:#C4956A; border:none; border-radius:50px; padding:10px 18px; font-size:13px; font-weight:500; color:#fff; cursor:pointer; box-shadow:0 4px 12px rgba(196,149,106,0.25); transition:all 0.2s; min-width:100px;">Accept
                    All</button>
                <button id="cookie-reject"
                    style="flex:1; background:transparent; border:1px solid #E6DFD6; border-radius:50px; padding:10px 18px; font-size:13px; font-weight:500; color:#2D2A24; cursor:pointer; transition:all 0.2s; min-width:80px;">Reject</button>
            </div>
        </div>
    </div>
