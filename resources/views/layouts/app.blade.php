...
<head>
    ...
    {{-- <meta name="description" content="{{$data->customPage->meta_description}}"> --}}
...
<body>
    ...
    <nav>
        ...
        <div class="nav-center">
            <a href="{{ route('show.home_page') }}" @if(Route::current()->getName() == 'show.home_page') class="active" @endif id="nav-home">Home</a>
            <a href="{{ route('show.custom_pages',  ['slug' => 'about']) }}" @if(Route::current()->getName() == 'show.custom_pages' && request()->slug == 'about') class="active" @endif id="nl-about">About</a>
            <a href="{{ route('show.custom_pages', ['slug' => 'seasons']) }}" @if(Route::current()->getName() == 'show.custom_pages' && request()->slug == 'seasons') class="active" @endif id="nl-seasons">Colour Seasons</a>
            <a href="{{ route('show.custom_pages', ['slug' => 'body-types']) }}" @if(Route::current()->getName() == 'show.custom_pages' && request()->slug == 'body-types') class="active" @endif id="nl-bodytypes">Body Types</a>
            <a href="{{ route('show.custom_pages', ['slug' => 'blog']) }}" @if(Route::current()->getName() == 'show.custom_pages' && request()->slug == 'blog') class="active" @endif id="nav-blog">Blog</a>
            <a href="{{ route('show.custom_pages', ['slug' => 'contact']) }}" @if(Route::current()->getName() == 'show.custom_pages' && request()->slug == 'contact') class="active" @endif id="nav-contact">Contact</a>
        </div>
        </div>
        <div class="nav-right">
